...
export type EmailType = 'signup' | 'invite' | 'magiclink' | 'recovery' | 'email_change';
...
export async function sendEmail(
  type: EmailType,
  params: BaseEmailParams | PasswordResetEmailParams | EmailConfirmationParams | MagicLinkEmailParams | EmailChangeParams | UserInvitationParams,
  ...
  try {
    switch (type) {
      ...
      case 'signup':
        ...
        throw new Error('Signup email sending should be handled during user creation');
      ...
      case 'invite':
        ...
        throw new Error('User invitations should be handled through custom API');
 ...
 */
export async function sendPasswordResetEmail(params: PasswordResetEmailParams, captchaToken?: string) {
 ...
 */
export async function sendMagicLinkEmail(params: MagicLinkEmailParams, captchaToken?: string) {
