try {
  ...
  r &&
    ...
    (e._sentryDebugIds[r] = "debaf20e-1056-46a0-9677-d65106a8de77"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-debaf20e-1056-46a0-9677-d65106a8de77"));
} catch (e) {}
(() => {
  var e = {};
  (e.id = 4943),
    ...
    (e.modules = {
      ...
      6376: (e, r, t) => {
        ...
        var o = t(63033),
          ...
          a = (0, i.registerClientReference)(
            function () {
              throw Error(
                "Attempted to call the default export of \"E:\\\\downloads\\\\Hijraah\\\\apps\\\\web\\\\src\\\\app\\\\[locale]\\\\support\\\\schedule\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
              );
            },
                ...
                apply: (e, r, t) => {
                  ...
                  return n
                    .wrapServerComponentWithSentry(e, {
                      componentRoute: "/[locale]/support/schedule",
                      componentType: "Page",
                      sentryTraceHeader: s,
                      baggageHeader: o,
                      headers: i,
      ...
      22946: (e, r, t) => {
        Promise.resolve().then(t.bind(t, 110));
      },
      27910: (e) => {
        "use strict";
        ...
        let p = {
                        ...
                        children: [
                          "schedule",
                          {
                            children: [
                              ...
                              {
                                page: [
                                  () => Promise.resolve().then(t.bind(t, 6376)),
                                  "E:\\downloads\\Hijraah\\apps\\web\\src\\app\\[locale]\\support\\schedule\\page.tsx",
                                ],
                              },
                            ],
          ...
          l = new s.AppPageRouteModule({
            definition: {
              ...
              page: "/[locale]/support/schedule/page",
              pathname: "/[locale]/support/schedule",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
