    ...
    return (
        ...
        >
            ...
            <p style={{
                ...
                We received a request to change the email address associated with your Hijraah account from <strong>{oldEmail}</strong> to <strong>{newEmail}</strong>.
            </p>
            ...
            <p style={{
                ...
                If you didn&apos;t request this change, please contact us immediately by replying to this email or through our support channels.
            </p>
