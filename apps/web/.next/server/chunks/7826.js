try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = "ddc67ea8-21ad-46f8-bd0c-3a46bba47a54"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-ddc67ea8-21ad-46f8-bd0c-3a46bba47a54"));
} catch (e) {}
("use strict");
(exports.id = 7826),
  (exports.ids = [7826]),
  (exports.modules = {
    12504: (e, t, r) => {
      let n = r(55591).Agent,
        s = r(28906),
        { INIT_SOCKET: o, CREATE_HTTPS_CONNECTION: i } = r(31102);
      class a extends s {
        constructor(e) {
          super(e),
    ...
    28906: (e, t, r) => {
      let n = r(81630).Agent,
        s = r(51587),
        o = r(28354).debuglog("agentkeepalive"),
        {
          INIT_SOCKET: i,
          CURRENT_ID: a,
          CREATE_ID: l,
          SOCKET_CREATED_TIME: u,
          SOCKET_NAME: c,
          SOCKET_REQUEST_COUNT: d,
          SOCKET_REQUEST_FINISHED_COUNT: h,
        } = r(31102),
        f = 1,
        p = parseInt(process.version.split(".", 1)[0].substring(1));
      function m(e) {
        console.log("[agentkeepalive:deprecated] %s", e);
      }
      p >= 11 && p <= 12 ? (f = 2) : p >= 13 && (f = 3);
      class y extends n {
        constructor(e) {
          ((e = e || {}).keepAlive = !1 !== e.keepAlive),
            ...
            (e.timeout = s(e.timeout)),
            (e.freeSocketTimeout = s(e.freeSocketTimeout)),
            (e.socketActiveTTL = e.socketActiveTTL ? s(e.socketActiveTTL) : 0),
            super(e),
            (this[a] = 0),
        ...
        reuseSocket(...e) {
          ...
          b(t) !== r &&
            (t.setTimeout(r), o("%s reset timeout to %sms", t[c], r)),
            t[d]++,
            o(
        ...
        [i](e, t) {
          t.timeout && (b(e) || e.setTimeout(t.timeout)),
            this.options.keepAlive && e.setNoDelay(!0),
            this.createSocketCount++,
            this.options.socketActiveTTL && (e[u] = Date.now()),
            (e[c] = `sock[${this[l]()}#${t._agentKey}]`.split(
              "-----BEGIN",
              1,
            )[0]),
            (e[d] = 1),
            ...
            (function (e, t, r) {
              function n() {
                if (!t._httpMessage && 1 === t[d]) return;
                t[h]++,
                  e.requestCount++,
                  o("%s(requests: %s, finished: %s) free", t[c], t[d], t[h]);
                let n = e.getName(r);
                t.writable &&
                  e.requests[n] &&
                  e.requests[n].length &&
              ...
              function i() {
                let n = t.listeners("timeout").length,
                  s = b(t),
                  i = t._httpMessage,
                  a = (i && i.listeners("timeout").length) || 0;
                o(
                ...
                if (e.freeSockets[l] && -1 !== e.freeSockets[l].indexOf(t))
                  t.destroy(),
                    e.removeSocket(t, r),
                    o("%s is free, destroy quietly", t[c]);
                else if (0 === a) {
                  let n = Error("Socket timeout");
                  (n.code = "ERR_SOCKET_TIMEOUT"),
                    (n.timeout = s),
                    t.destroy(n),
                    e.removeSocket(t, r),
                    o("%s destroy with timeout error", t[c]);
                }
              }
              function a(r) {
                let n = t.listeners("error").length;
                o(
                  ...
                  e.errorSocketCount++,
                  1 === n &&
                    (o("%s emit uncaught error event", t[c]),
                    t.removeListener("error", a),
                    t.emit("error", r));
              }
              o("%s create, timeout %sms", t[c], b(t)),
                t.on("free", n),
                t.on("close", s),
                t.on("timeout", i),
                t.on("error", a),
        ...
        createConnection(e, t) {
          let r = !1,
            n = (n, s) => {
              if (!r) {
                if (((r = !0), n)) return this.createSocketErrorCount++, t(n);
                this[i](s, e), t(n, s);
              }
            },
            s = super.createConnection(e, n);
          return s && n(null, s), s;
        }
        get statusChanged() {
          let e =
        ...
        getCurrentStatus() {
          return {
            ...
            freeSockets: g(this.freeSockets),
            sockets: g(this.sockets),
            requests: g(this.requests),
          };
        }
      }
      function b(e) {
    ...
    28993: (e, t, r) => {
      ...
      let a = Promise,
        ...
        u = Promise.resolve.bind(a),
        c = Promise.reject.bind(a);
      function d(e) {
        return new a(e);
      }
      function h(e, t, r) {
        ...
        forEach(e) {
          ...
          for (
            ...
            !(
              ...
              (t === n.length &&
                ((n = (r = r._next)._elements), (t = 0), 0 === n.length))
            );
      ...
      function E(e, t) {
        ...
        (e._ownerReadableStream = t),
          ...
          "readable" === t._state
            ...
            : "closed" === t._state
              ? (P(e), C(e))
              : ((r = e), (n = t._storedError), P(r), A(r, n));
      }
      function R(e, t) {
        return tk(e._ownerReadableStream, t);
      }
      function k(e) {
        var t, r;
      ...
      function W(e, t) {
        ...
        if ((o = 0 === (n = $(o)) ? 0 : n) < 0 || o > s)
          throw TypeError(
            `${t} is outside the accepted range of 0 to ${s}, inclusive`,
          );
        return O(o) && 0 !== o ? o : 0;
      }
      function F(e) {
        if (!o(e) || "function" != typeof e.getReader) return !1;
        try {
      ...
      function N(e) {
        if (!o(e) || "function" != typeof e.getWriter) return !1;
        try {
          return "boolean" == typeof e.locked;
        } catch (e) {
          return !1;
      ...
      function D(e, t) {
        if (!tE(e)) throw TypeError(`${t} is not a ReadableStream.`);
      }
      function z(e, t) {
        e._reader._readRequests.push(t);
      }
      function U(e, t, r) {
        let n = e._reader._readRequests.shift();
      ...
      class J {
        constructor(e) {
          if (
            (L(e, 1, "ReadableStreamDefaultReader"),
            D(e, "First parameter"),
            tR(e))
          )
            throw TypeError(
          ...
          E(this, e), (this._readRequests = new g());
        }
        get closed() {
          return X(this) ? this._closedPromise : c(Q("closed"));
        }
        cancel(e) {
          return X(this)
        ...
        read() {
          let e, t;
          if (!X(this)) return c(Q("read"));
          if (void 0 === this._ownerReadableStream) return c(x("read from"));
          let r = d((r, n) => {
            (e = r), (t = n);
          });
          return (
              ...
              (r._disturbed = !0),
                "closed" === r._state
                  ...
                  : "errored" === r._state
                    ...
                    : r._readableStreamController[S](t);
            })(this, {
        ...
        releaseLock() {
          if (!X(this)) throw Q("releaseLock");
          void 0 !== this._ownerReadableStream &&
            (k(this), K(this, TypeError("Reader was released")));
        }
      }
      function X(e) {
        return (
      ...
      Object.defineProperties(J.prototype, {
        ...
        i(J.prototype.cancel, "cancel"),
        i(J.prototype.read, "read"),
        i(J.prototype.releaseLock, "releaseLock"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(J.prototype, n.toStringTag, {
      ...
      class Y {
        ...
        _returnSteps(e) {
          ...
          this._isFinished = !0;
          let t = this._reader;
          if (void 0 === t) return c(x("finish iterating"));
          if (((this._reader = void 0), !this._preventCancel)) {
            let r = t.cancel(e);
            return (
              t.releaseLock(), h(r, () => ({ value: e, done: !0 }), void 0)
            );
          }
          return t.releaseLock(), u({ value: e, done: !0 });
        }
      }
      let G = {
        next() {
          return Z(this) ? this._asyncIteratorImpl.next() : c(ee("next"));
        },
        return(e) {
          return Z(this) ? this._asyncIteratorImpl.return(e) : c(ee("return"));
        },
      };
      function Z(e) {
        if (
          ...
          return !1;
        try {
          return e._asyncIteratorImpl instanceof Y;
        } catch (e) {
          return !1;
        }
      }
      ...
      function er(e, t, r, n, s) {
        new Uint8Array(e).set(new Uint8Array(r, n, s), t);
      }
      function en(e) {
      ...
      class ea {
        ...
        get view() {
          if (!ec(this)) throw eA("view");
          return this._view;
        }
        respond(e) {
          if (!ec(this)) throw eA("respond");
          if (
            (L(e, 1, "respond"),
            (e = W(e, "First parameter")),
          ...
          this._view.buffer,
            (function (e, t) {
              ...
              (r.buffer = r.buffer), eT(e, t);
            })(this._associatedReadableByteStreamController, e);
        }
        respondWithNewView(e) {
          if (!ec(this)) throw eA("respondWithNewView");
          if ((L(e, 1, "respondWithNewView"), !ArrayBuffer.isView(e)))
      ...
      Object.defineProperties(ea.prototype, {
        ...
        i(ea.prototype.respond, "respond"),
        i(ea.prototype.respondWithNewView, "respondWithNewView"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(ea.prototype, n.toStringTag, {
      ...
      class el {
        ...
        get byobRequest() {
          if (!eu(this)) throw eC("byobRequest");
          return (function (e) {
            if (null === e._byobRequest && e._pendingPullIntos.length > 0) {
              let t = e._pendingPullIntos.peek(),
                ...
                n = Object.create(ea.prototype);
              (n._associatedReadableByteStreamController = e),
                (n._view = r),
                (e._byobRequest = n);
            }
        ...
        get desiredSize() {
          if (!eu(this)) throw eC("desiredSize");
          return eP(this);
        }
        close() {
          if (!eu(this)) throw eC("close");
        ...
        enqueue(e) {
          if (!eu(this)) throw eC("enqueue");
          if ((L(e, 1, "enqueue"), !ArrayBuffer.isView(e)))
            ...
            V(r)
              ? ((function (e) {
                  ...
                  for (; t._readRequests.length > 0; ) {
                    ...
                    ex(e, t._readRequests.shift());
                  }
                })(e),
                0 === H(r))
                ? em(e, n, s, o)
                : (e._pendingPullIntos.length > 0 && eE(e),
                  U(r, new Uint8Array(n, s, o), !1))
              : ej(r)
                ? (em(e, n, s, o), eS(e))
                : em(e, n, s, o),
              ed(e);
        ...
        [S](e) {
          ...
          if (this._queueTotalSize > 0) return void ex(this, e);
        ...
        if (
          ...
          (e._pulling = !0),
            f(
              ...
              () => (
                (e._pulling = !1),
                e._pullAgain && ((e._pullAgain = !1), ed(e)),
                null
              ),
              (t) => (ek(e, t), null),
            );
      ...
      function eh(e) {
        ev(e), (e._pendingPullIntos = new g());
      }
      function ef(e, t) {
        let r = !1;
        "closed" === e._state && (r = !0);
      ...
      function eb(e, t) {
        t.bytesFilled > 0 && ey(e, t.buffer, t.byteOffset, t.bytesFilled),
          eE(e);
      }
      function eg(e, t) {
        let r = t.elementSize,
          n = t.bytesFilled - (t.bytesFilled % r),
          s = Math.min(e._queueTotalSize, t.byteLength - t.bytesFilled),
          o = t.bytesFilled + s,
          i = o - (o % r),
          a = s,
          l = !1;
        i > n && ((a = i - t.bytesFilled), (l = !0));
        let u = e._queue;
        for (; a > 0; ) {
          let r = u.peek(),
            n = Math.min(a, r.byteLength),
            s = t.byteOffset + t.bytesFilled;
          er(t.buffer, s, r.buffer, r.byteOffset, n),
            r.byteLength === n
              ? u.shift()
              : ((r.byteOffset += n), (r.byteLength -= n)),
            (e._queueTotalSize -= n),
            e_(e, n, t),
            (a -= n);
        }
      ...
      function ew(e) {
        0 === e._queueTotalSize && e._closeRequested
          ? (eR(e), tx(e._controlledReadableByteStream))
          : ed(e);
      }
      function ev(e) {
        null !== e._byobRequest &&
      ...
      function eS(e) {
        for (; e._pendingPullIntos.length > 0; ) {
          if (0 === e._queueTotalSize) return;
          let t = e._pendingPullIntos.peek();
          eg(e, t) && (eE(e), ef(e._controlledReadableByteStream, t));
        }
      }
      function eT(e, t) {
        let r = e._pendingPullIntos.peek();
        ev(e),
          "closed" === e._controlledReadableByteStream._state
            ? (function (e, t) {
                "none" === t.readerType && eE(e);
                let r = e._controlledReadableByteStream;
                if (ej(r)) for (; e$(r) > 0; ) ef(r, eE(e));
              })(e, r)
            : (function (e, t, r) {
                if ((e_(0, t, r), "none" === r.readerType))
                  return eb(e, r), eS(e);
                ...
                (r.bytesFilled -= n),
                  ef(e._controlledReadableByteStream, r),
                  eS(e);
              })(e, t, r),
          ed(e);
      }
      ...
      function ek(e, t) {
        let r = e._controlledReadableByteStream;
        "readable" === r._state && (eh(e), ei(e), eR(e), tP(r, t));
      }
      function ex(e, t) {
        let r = e._queue.shift();
        (e._queueTotalSize -= r.byteLength), ew(e);
        let n = new Uint8Array(r.buffer, r.byteOffset, r.byteLength);
        t._chunkSteps(n);
      }
      function eP(e) {
      ...
      Object.defineProperties(el.prototype, {
        ...
        i(el.prototype.close, "close"),
        i(el.prototype.enqueue, "enqueue"),
        i(el.prototype.error, "error"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(el.prototype, n.toStringTag, {
      ...
      class eI {
        constructor(e) {
          if (
            (L(e, 1, "ReadableStreamBYOBReader"),
            D(e, "First parameter"),
            tR(e))
          )
            throw TypeError(
          ...
          if (!eu(e._readableStreamController))
            throw TypeError(
              "Cannot construct a ReadableStreamBYOBReader for a stream not constructed with a byte source",
            );
          E(this, e), (this._readIntoRequests = new g());
        }
        get closed() {
          return eq(this) ? this._closedPromise : c(eB("closed"));
        }
        cancel(e) {
          return eq(this)
            ? void 0 === this._ownerReadableStream
        ...
        read(e) {
          let t, r;
          if (!eq(this)) return c(eB("read"));
          if (!ArrayBuffer.isView(e))
            return c(TypeError("view must be an array buffer view"));
          if (0 === e.byteLength)
            return c(TypeError("view must have non-zero byteLength"));
          if (0 === e.buffer.byteLength)
            return c(TypeError("view's buffer must have non-zero byteLength"));
          if ((e.buffer, void 0 === this._ownerReadableStream))
            return c(x("read from"));
          let n = d((e, n) => {
            (t = e), (r = n);
          });
          return (
                ...
                "errored" === n._state
                  ...
                  : (function (e, t, r) {
                      ...
                      t.constructor !== DataView &&
                        (s = t.constructor.BYTES_PER_ELEMENT);
                      let o = t.constructor,
                        i = t.buffer,
                        a = {
                          buffer: i,
                      ...
                      if (e._pendingPullIntos.length > 0)
                        return e._pendingPullIntos.push(a), eO(n, r);
                      if ("closed" !== n._state) {
                        if (e._queueTotalSize > 0) {
                          if (eg(e, a)) {
                            let t = ep(a);
                            return ew(e), r._chunkSteps(t);
                          }
                          if (e._closeRequested) {
                            let t = TypeError(
                              "Insufficient bytes to fill elements in the given buffer",
                            );
                            return ek(e, t), r._errorSteps(t);
                          }
                        }
                        e._pendingPullIntos.push(a), eO(n, r), ed(e);
                      } else {
                        let e = new o(a.buffer, a.byteOffset, 0);
                        r._closeSteps(e);
                      }
        ...
        releaseLock() {
          if (!eq(this)) throw eB("releaseLock");
          void 0 !== this._ownerReadableStream &&
            (k(this), eL(this, TypeError("Reader was released")));
        }
      }
      function eq(e) {
        return (
      ...
      function eF(e, t) {
        var r;
        j(e, t);
        let n = null == e ? void 0 : e.highWaterMark,
          s = null == e ? void 0 : e.size;
        return {
          highWaterMark: void 0 === n ? void 0 : M(n),
          size:
            void 0 === s
              ? void 0
              : (I((r = s), `${t} has member 'size' that`), (e) => M(r(e))),
        };
      }
      Object.defineProperties(eI.prototype, {
        ...
        i(eI.prototype.cancel, "cancel"),
        i(eI.prototype.read, "read"),
        i(eI.prototype.releaseLock, "releaseLock"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(eI.prototype, n.toStringTag, {
            value: "ReadableStreamBYOBReader",
            configurable: !0,
          });
      let eN = "function" == typeof AbortController;
      class eD {
        constructor(e = {}, t = {}) {
            ...
            n = (function (e, t) {
              ...
              return {
                ...
                close:
                  void 0 === n
                    ? void 0
                    : (I(n, `${t} has member 'close' that`), () => b(n, e, [])),
                start:
                  void 0 === s
                    ? void 0
                    : (I(s, `${t} has member 'start' that`),
                      (t) => y(s, e, [t])),
                write:
                  void 0 === i
                    ? void 0
          ...
          !(function (e, t, r, n) {
            ...
            (s = void 0 !== t.start ? () => t.start(l) : () => {}),
              (o = void 0 !== t.write ? (e) => t.write(e, l) : () => u(void 0)),
              (i = void 0 !== t.close ? () => t.close() : () => u(void 0)),
              (a = void 0 !== t.abort ? (e) => t.abort(e) : () => u(void 0)),
              ...
              (l._abortController = (function () {
                if (eN) return new AbortController();
              })()),
              (l._started = !1),
              (l._strategySizeAlgorithm = n),
              (l._strategyHWM = r),
              (l._writeAlgorithm = o),
              (l._closeAlgorithm = i),
              (l._abortAlgorithm = a),
              ...
              f(
                u(s()),
                () => ((l._started = !0), e5(l), null),
                (t) => ((l._started = !0), eJ(e, t), null),
              );
          })(this, n, eM(r, 1), s);
        }
        get locked() {
          if (!ez(this)) throw te("locked");
          return eU(this);
        }
        abort(e) {
          return ez(this)
            ? eU(this)
              ? c(TypeError("Cannot abort a stream that already has a writer"))
              : eH(this, e)
            : c(te("abort"));
        }
        close() {
          return ez(this)
            ? eU(this)
              ? c(TypeError("Cannot close a stream that already has a writer"))
              : eQ(this)
                ? c(TypeError("Cannot close an already-closing stream"))
                : eV(this)
            : c(te("close"));
        }
        getWriter() {
          if (!ez(this)) throw te("getWriter");
          return new eZ(this);
        }
      }
      function ez(e) {
      ...
      function eH(e, t) {
        ...
        return (e._pendingAbortRequest._promise = o), s || eX(e, t), o;
      }
      function eV(e) {
        var t;
        let r = e._state;
        ...
        let n = d((t, r) => {
          ...
          s = e._writer;
        return (
          void 0 !== s && e._backpressure && "writable" === r && tc(s),
          eo((t = e._writableStreamController), e2, 0),
          e5(t),
          n
        );
      }
      function eJ(e, t) {
        "writable" !== e._state ? eK(e) : eX(e, t);
      }
      function eX(e, t) {
      ...
      function eK(e) {
        ...
        if (((e._pendingAbortRequest = void 0), r._wasAlreadyErroring))
          return r._reject(t), void eY(e);
        f(
          e._writableStreamController[_](r._reason),
          () => (r._resolve(), eY(e), null),
          (t) => (r._reject(t), eY(e), null),
        );
      }
      function eQ(e) {
      ...
      function eY(e) {
        ...
        let t = e._writer;
        void 0 !== t && to(t, e._storedError);
      }
      function eG(e, t) {
        let r = e._writer;
        void 0 !== r && t !== e._backpressure && (t ? ta(r) : tc(r)),
          (e._backpressure = t);
      }
      Object.defineProperties(eD.prototype, {
        ...
        i(eD.prototype.abort, "abort"),
        i(eD.prototype.close, "close"),
        i(eD.prototype.getWriter, "getWriter"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(eD.prototype, n.toStringTag, {
      ...
      class eZ {
        constructor(e) {
          if (
            (L(e, 1, "WritableStreamDefaultWriter"),
            (function (e, t) {
              if (!ez(e)) throw TypeError(`${t} is not a WritableStream.`);
            })(e, "First parameter"),
            eU(e))
          )
            throw TypeError(
          ...
          let t = e._state;
          if ("writable" === t)
            !eQ(e) && e._backpressure
              ? ta(this)
              : (function (e) {
                  ta(e), tc(e);
                })(this),
              ts(this);
          else if ("erroring" === t) tl(this, e._storedError), ts(this);
          else if ("closed" === t)
            (function (e) {
              ta(e), tc(e);
            })(this),
        ...
        get closed() {
          return e0(this) ? this._closedPromise : c(tr("closed"));
        }
        get desiredSize() {
          if (!e0(this)) throw tr("desiredSize");
          if (void 0 === this._ownerWritableStream) throw tn("desiredSize");
          ...
          return "errored" === t || "erroring" === t
            ...
            : "closed" === t
              ? 0
              : e6(e._writableStreamController);
        }
        get ready() {
          return e0(this) ? this._readyPromise : c(tr("ready"));
        }
        abort(e) {
          return e0(this)
        ...
        close() {
          if (!e0(this)) return c(tr("close"));
          let e = this._ownerWritableStream;
          return void 0 === e
            ? c(tn("close"))
            : eQ(e)
              ? c(TypeError("Cannot close an already-closing stream"))
              : eV(this._ownerWritableStream);
        }
        releaseLock() {
          ...
          return e0(this)
            ? void 0 === this._ownerWritableStream
              ...
              : (function (e, t) {
                  ...
                  if (r !== e._ownerWritableStream) return c(tn("write to"));
                  let o = r._state;
                  if ("errored" === o) return c(r._storedError);
                  if (eQ(r) || "closed" === o)
                    return c(
                      TypeError(
                  ...
                  if ("erroring" === o) return c(r._storedError);
                  let i = d((e, t) => {
                  ...
                  return (
                    (function (e, t, r) {
                      ...
                      eQ(n) || "writable" !== n._state || eG(n, 0 >= e6(e)),
                        e5(e);
                    })(n, t, s),
                    i
                  );
      ...
      function e1(e, t) {
        "pending" === e._readyPromiseState ? tu(e, t) : tl(e, t);
      }
      Object.defineProperties(eZ.prototype, {
        ...
        i(eZ.prototype.abort, "abort"),
        i(eZ.prototype.close, "close"),
        i(eZ.prototype.releaseLock, "releaseLock"),
        i(eZ.prototype.write, "write"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(eZ.prototype, n.toStringTag, {
      ...
      class e3 {
        ...
        error(e) {
          ...
          "writable" === this._controlledWritableStream._state && e7(this, e);
        }
        [_](e) {
              ...
              (r._inFlightWriteRequest = r._writeRequests.shift()),
                f(
                  ...
                  () => {
                    ...
                    return (
                      es(e),
                      eQ(r) || "writable" !== t || eG(r, 0 >= e6(e)),
                      e5(e),
                      null
                    );
                  },
                  (t) => (
                    "writable" === r._state && e4(e),
      ...
      function e9(e, t) {
        "writable" === e._controlledWritableStream._state && e7(e, t);
      }
      function e7(e, t) {
        let r = e._controlledWritableStream;
        e4(e), eX(r, t);
      ...
      Object.defineProperties(e3.prototype, {
        ...
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(e3.prototype, n.toStringTag, {
            value: "WritableStreamDefaultController",
            configurable: !0,
          });
      let td = "undefined" != typeof DOMException ? DOMException : void 0,
        th = !(function (e) {
            ...
            (void 0 !== o &&
              ((P = () => {
                let e =
                    void 0 !== o.reason
                      ? o.reason
                      : new th("Aborted", "AbortError"),
                  t = [];
                n || t.push(() => ("writable" === v ? a.abort(e) : u(void 0))),
                  s ||
                    t.push(() => ("readable" === w ? i.cancel(e) : u(void 0))),
                  j(() => Promise.all(t.map((e) => e())), !0, e);
              }),
              o.aborted ? P() : o.addEventListener("abort", P)),
            tE(e) && ((w = e._state), (l = e._storedError)),
            ez(t) && ((v = t._state), (y = t._storedError), (S = eQ(t))),
            tE(e) && ez(t) && ((T = !0), b()),
            "errored" === w)
          )
            O(l);
          else if ("erroring" === v || "errored" === v) $(y);
          else if ("closed" === w) C();
          else if (S || "closed" === v) {
            let e = TypeError(
      ...
      class tp {
        ...
        close() {
          ...
          !(function (e) {
            ...
            (e._closeRequested = !0), 0 === e._queue.length && (tb(e), tx(t));
          })(this);
        }
        enqueue(e) {
      ...
      function ty(e) {
        if (
          (function (e) {
            let t = e._controlledReadableStream;
            return (
              !!tw(e) && !!e._started && !!((tR(t) && H(t) > 0) || t_(e) > 0)
            );
          })(e)
        ) {
          if (e._pulling) return void (e._pullAgain = !0);
          (e._pulling = !0),
            f(
              ...
              () => (
                (e._pulling = !1),
                e._pullAgain && ((e._pullAgain = !1), ty(e)),
                null
              ),
              (t) => (tg(e, t), null),
            );
      ...
      function tg(e, t) {
        ...
        "readable" === r._state && (ei(e), tb(e), tP(r, t));
      }
      function t_(e) {
      ...
      function tS(e, t) {
        ...
        let r = null == e ? void 0 : e.preventAbort,
          ...
          s = null == e ? void 0 : e.preventClose,
      ...
      Object.defineProperties(tp.prototype, {
        ...
        i(tp.prototype.close, "close"),
        i(tp.prototype.enqueue, "enqueue"),
        i(tp.prototype.error, "error"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(tp.prototype, n.toStringTag, {
      ...
      class tT {
            ...
            n = (function (e, t) {
              ...
              return {
                autoAllocateChunkSize:
                  void 0 === r
                    ? void 0
                    : W(r, `${t} has member 'autoAllocateChunkSize' that`),
                cancel:
                  void 0 === n
                    ? void 0
                ...
                pull:
                  void 0 === s
                    ? void 0
                    : (I(s, `${t} has member 'pull' that`),
                      (t) => b(s, e, [t])),
                start:
                  void 0 === o
                    ? void 0
                    : (I(o, `${t} has member 'start' that`),
                      (t) => y(o, e, [t])),
                type:
                  void 0 === i
                    ? void 0
          ...
          if (
            ...
            !(function (e, t, r) {
              let n,
                s,
                o,
                i = Object.create(el.prototype);
              (n = void 0 !== t.start ? () => t.start(i) : () => {}),
                (s = void 0 !== t.pull ? () => t.pull(i) : () => u(void 0)),
                (o =
              ...
              (i._controlledReadableByteStream = e),
                (i._pullAgain = !1),
                (i._pulling = !1),
                (i._byobRequest = null),
                (i._queue = i._queueTotalSize = void 0),
                ei(i),
                (i._closeRequested = !1),
                (i._started = !1),
                (i._strategyHWM = r),
                (i._pullAlgorithm = s),
                (i._cancelAlgorithm = o),
                (i._autoAllocateChunkSize = a),
                (i._pendingPullIntos = new g()),
                (e._readableStreamController = i),
                f(
                  u(n()),
                  () => ((i._started = !0), ed(i), null),
                  (e) => (ek(i, e), null),
                );
            })(this, n, eM(r, 0));
          } else {
            ...
            !(function (e, t, r, n) {
              let s,
                o,
                i,
                a = Object.create(tp.prototype);
              (s = void 0 !== t.start ? () => t.start(a) : () => {}),
                (o = void 0 !== t.pull ? () => t.pull(a) : () => u(void 0)),
                (i =
                  void 0 !== t.cancel ? (e) => t.cancel(e) : () => u(void 0)),
                ...
                (a._pullAgain = !1),
                (a._pulling = !1),
                (a._strategySizeAlgorithm = n),
                (a._strategyHWM = r),
                (a._pullAlgorithm = o),
                (a._cancelAlgorithm = i),
                (e._readableStreamController = a),
                f(
                  u(s()),
                  () => ((a._started = !0), ty(a), null),
                  (e) => (tg(a, e), null),
                );
            })(this, n, eM(r, 1), e);
          }
        ...
        get locked() {
          if (!tE(this)) throw tA("locked");
          return tR(this);
        }
        cancel(e) {
          return tE(this)
            ? tR(this)
              ? c(TypeError("Cannot cancel a stream that already has a reader"))
              : tk(this, e)
            : c(tA("cancel"));
        }
        getReader(e) {
          if (!tE(this)) throw tA("getReader");
          return void 0 ===
            (function (e, t) {
              j(e, t);
        ...
        pipeThrough(e, t = {}) {
          if (!F(this)) throw tA("pipeThrough");
          L(e, 1, "pipeThrough");
          let r = (function (e, t) {
              j(e, t);
              let r = null == e ? void 0 : e.readable;
              B(r, "readable", "ReadableWritablePair"),
                (function (e, t) {
                  if (!F(e)) throw TypeError(`${t} is not a ReadableStream.`);
                })(r, `${t} has member 'readable' that`);
              let n = null == e ? void 0 : e.writable;
              return (
                B(n, "writable", "ReadableWritablePair"),
                (function (e, t) {
                  if (!N(e)) throw TypeError(`${t} is not a WritableStream.`);
                })(n, `${t} has member 'writable' that`),
                { readable: r, writable: n }
              );
            })(e, "First parameter"),
            n = tS(t, "Second parameter");
          if (this.locked)
            throw TypeError(
            ...
            ? (function (e, t) {
                ...
                return (
                  f(
                    ...
                    void 0,
                    (e) => (
                      o.error(e), i.error(e), (h && p) || a(void 0), null
                    ),
                  ),
                  [b, g]
                );
            ...
            : (function (e) {
                ...
                function b(e) {
                  f(
                    ...
                    (t) => (
                      e !== i ||
                        (n.error(t), s.error(t), (p && m) || o(void 0)),
                      null
                    ),
                  );
                }
                function g() {
                  a && (i.releaseLock(), b((i = e.getReader())), (a = !1)),
                    f(
                      i.read(),
                      (e) => {
                        var t, r;
                        if (((c = !1), (h = !1), e.done))
                          return (
                            p || n.close(),
                            m || s.close(),
                            null == (t = n.byobRequest) || t.respond(0),
                            null == (r = s.byobRequest) || r.respond(0),
                            (p && m) || o(void 0),
                            null
                          );
                        let a = e.value,
                        ...
                        if (!p && !m)
                          try {
                            ...
                            return n.error(e), s.error(e), o(i.cancel(e)), null;
                          }
                        return (
                          p || n.enqueue(a),
                          m || s.enqueue(u),
                  ...
                  f(
                    ...
                    (e) => {
                      ...
                      if (e.done) {
                        ...
                        return (
                          void 0 !== r &&
                            (n || u.byobRequest.respondWithNewView(r),
                            s || null == (t = d.byobRequest) || t.respond(0)),
                          (n && s) || o(void 0),
                          null
                        );
                      }
                      let a = e.value;
                      if (s) n || u.byobRequest.respondWithNewView(a);
                      else {
                        let e;
                        try {
                          e = en(a);
                        } catch (e) {
                          return u.error(e), d.error(e), o(i.cancel(e)), null;
                        }
                        n || u.byobRequest.respondWithNewView(a), d.enqueue(e);
                      }
                      return (l = !1), c ? w() : h && v(), null;
                    },
                    () => ((l = !1), null),
                  );
                }
                function w() {
                  ...
                  l = !0;
                  let e = n.byobRequest;
                  return null === e ? g() : _(e.view, !1), u(void 0);
                }
                function v() {
                  if (l) return (h = !0), u(void 0);
                  l = !0;
                  let e = s.byobRequest;
                  return null === e ? g() : _(e.view, !0), u(void 0);
                }
                let S = new tT({
                    type: "bytes",
                    start(e) {
        ...
        values(e) {
          if (!F(this)) throw tA("values");
          return (function (e, t) {
            let r = new Y(e.getReader(), t),
              n = Object.create(G);
            return (n._asyncIteratorImpl = r), n;
          })(
            this,
            (j(e, "First parameter"),
      ...
      function tk(e, t) {
        ...
        return h(e._readableStreamController[v](t), s, void 0);
      }
      function tx(e) {
        e._state = "closed";
        let t = e._reader;
      ...
      function tP(e, t) {
        ...
        let r = e._reader;
        void 0 !== r && (A(r, t), X(r) ? K(r, t) : eL(r, t));
      }
      function tA(e) {
        return TypeError(
      ...
      function tC(e, t) {
        ...
        return (
          B(r, "highWaterMark", "QueuingStrategyInit"), { highWaterMark: M(r) }
        );
      }
      Object.defineProperties(tT.prototype, {
        ...
        i(tT.prototype.cancel, "cancel"),
        i(tT.prototype.getReader, "getReader"),
        i(tT.prototype.pipeThrough, "pipeThrough"),
        i(tT.prototype.pipeTo, "pipeTo"),
        i(tT.prototype.tee, "tee"),
        i(tT.prototype.values, "values"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(tT.prototype, n.toStringTag, {
            value: "ReadableStream",
            configurable: !0,
          }),
        "symbol" == typeof n.asyncIterator &&
          Object.defineProperty(tT.prototype, n.asyncIterator, {
            value: tT.prototype.values,
            writable: !0,
            configurable: !0,
          });
      let tO = (e) => e.byteLength;
      i(tO, "size");
      class t$ {
        constructor(e) {
          L(e, 1, "ByteLengthQueuingStrategy"),
            (e = tC(e, "First parameter")),
            (this._byteLengthQueuingStrategyHighWaterMark = e.highWaterMark);
        }
        get highWaterMark() {
          if (!tI(this)) throw tj("highWaterMark");
          return this._byteLengthQueuingStrategyHighWaterMark;
        }
        get size() {
          if (!tI(this)) throw tj("size");
          return tO;
        }
      }
      function tj(e) {
      ...
      Object.defineProperties(t$.prototype, {
        ...
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(t$.prototype, n.toStringTag, {
      ...
      class tL {
        constructor(e) {
          L(e, 1, "CountQueuingStrategy"),
            (e = tC(e, "First parameter")),
            (this._countQueuingStrategyHighWaterMark = e.highWaterMark);
        }
        get highWaterMark() {
          if (!tM(this)) throw tB("highWaterMark");
          return this._countQueuingStrategyHighWaterMark;
        }
        get size() {
          if (!tM(this)) throw tB("size");
          return tq;
        }
      }
      function tB(e) {
      ...
      Object.defineProperties(tL.prototype, {
        ...
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(tL.prototype, n.toStringTag, {
      ...
      class tW {
        constructor(e = {}, t = {}, r = {}) {
          let n;
          void 0 === e && (e = null);
          let s = eF(t, "Second parameter"),
            o = eF(r, "Third parameter"),
            i = (function (e, t) {
              j(e, t);
              let r = null == e ? void 0 : e.flush,
                n = null == e ? void 0 : e.readableType,
                s = null == e ? void 0 : e.start,
                o = null == e ? void 0 : e.transform,
              ...
              return {
                ...
                transform:
                  void 0 === o
                    ? void 0
                    : (I(o, `${t} has member 'transform' that`),
                      (t, r) => b(o, e, [t, r])),
                writableType: i,
              };
            })(e, "First parameter");
          ...
          !(function (e, t, r, n, s, o) {
            ...
            (e._writableState = "writable"),
              ...
              (a = function () {
                ...
                return (
                  ...
                  h(
                    ...
                    (e) => {
                      throw (tN(t, e), t._readableStoredError);
                    },
                  )
                );
              }),
              (e._writable = new eD(
                {
                  ...
                  write: (t) => (
                    ...
                    h(
                      ...
                      (t) => {
                        throw (
                          ((e._writableHasInFlightOperation = !1), t1(e, t), t)
                        );
                      },
                    )
                  ),
                  ...
                  abort: (t) => (
                    ...
                    (function (t) {
                      return tN(e, t), u(void 0);
                    })(t)
                  ),
                },
                { highWaterMark: r, size: n },
              )),
              ...
              (l = function () {
                return tz(e, !1), e._backpressureChangePromise;
              }),
              (e._readable = new tT(
                {
                  start: (t) => (
                  ...
                  cancel: (t) => (
                    ...
                    (function (t) {
                      return tD(e, t), u(void 0);
                    })(t)
                  ),
                },
                { highWaterMark: s, size: o },
              )),
              ...
              (r =
                void 0 !== t.transform
                  ...
                  : (e) => {
                      try {
                        var t;
                        return tJ(s, e), (t = void 0), u(t);
                      } catch (e) {
                        return c(e);
                      }
                    }),
                (n = void 0 !== t.flush ? () => t.flush(s) : () => u(void 0)),
                (s._controlledTransformStream = e),
                (e._transformStreamController = s),
                (s._transformAlgorithm = r),
                (s._flushAlgorithm = n);
            })(this, i),
            void 0 !== i.start
              ? n(i.start(this._transformStreamController))
              : n(void 0);
        }
        get readable() {
          if (!tF(this)) throw tQ("readable");
          return this._readable;
        }
        get writable() {
          if (!tF(this)) throw tQ("writable");
      ...
      Object.defineProperties(tW.prototype, {
        ...
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(tW.prototype, n.toStringTag, {
      ...
      class tU {
        ...
        error(e) {
          ...
          tN(this._controlledTransformStream, e);
        }
        terminate() {
          if (!tH(this)) throw tK("terminate");
          let e = this._controlledTransformStream;
          tY(e) && tG(e), tD(e, TypeError("TransformStream terminated"));
        }
      }
      function tH(e) {
        return (
      ...
      function tJ(e, t) {
        ...
        !(tY(r) && (r._readablePulling || t0(r) > 0)) !== r._backpressure &&
          tz(r, !0);
      }
      function tX(e, t) {
        return h(e._transformAlgorithm(t), void 0, (t) => {
          throw (tN(e._controlledTransformStream, t), t);
        });
      }
      function tK(e) {
        return TypeError(
      ...
      Object.defineProperties(tU.prototype, {
        ...
        i(tU.prototype.enqueue, "enqueue"),
        i(tU.prototype.error, "error"),
        i(tU.prototype.terminate, "terminate"),
        "symbol" == typeof n.toStringTag &&
          Object.defineProperty(tU.prototype, n.toStringTag, {
      ...
      async function* t7(e) {
        let t = e.byteOffset + e.byteLength,
          r = e.byteOffset;
        for (; r !== t; ) {
          let n = Math.min(t - r, 65536),
            s = e.buffer.slice(r, r + n);
          (r += s.byteLength), yield new Uint8Array(s);
        }
      }
      async function* re(e) {
        let t = 0;
        for (; t !== e.size; ) {
          ...
          (t += n.byteLength), yield new Uint8Array(n);
        }
      }
      ...
      class rs {
        constructor(e = [], t = {}) {
          ...
          let n = void 0 === t.type ? "" : String(t.type);
          rn(this, t6, /^[\x20-\x7E]*$/.test(n) ? n : "", "f");
        }
        static [((t4 = new WeakMap()),
        (t6 = new WeakMap()),
        (t5 = new WeakMap()),
        Symbol.hasInstance)](e) {
          return !!(
            e &&
            "object" == typeof e &&
            (0, t9.T)(e.constructor) &&
            ((0, t9.T)(e.stream) || (0, t9.T)(e.arrayBuffer)) &&
        ...
        slice(e, t, r) {
          return new rs(
            (function* (e, t, r = 0, n) {
              null != n || (n = t);
              let s = r < 0 ? Math.max(t + r, 0) : Math.min(r, t),
              ...
              for (let t of e) {
                ...
                if (s && e <= s) (s -= e), (o -= e);
                  ...
                  ArrayBuffer.isView(t)
                    ? (a += (r = t.subarray(s, Math.min(e, o))).byteLength)
                    : (a += (r = t.slice(s, Math.min(e, o))).size),
                    (o -= e),
                    (s = 0),
                    yield r;
                }
              }
            })(rr(this, t4, "f"), this.size, e, t),
            { type: r },
          );
        }
        async text() {
          let e = new TextDecoder(),
            t = "";
          for await (let r of rt(rr(this, t4, "f")))
        ...
        stream() {
          let e = rt(rr(this, t4, "f"), !0);
          return new tT({
            async pull(t) {
              let { value: r, done: n } = await e.next();
              if (n) return queueMicrotask(() => t.close());
              t.enqueue(r);
            },
            async cancel() {
              await e.return();
    ...
    47684: (e, t, r) => {
      ...
      class l extends o.Y {
        constructor(e, t, r = {}) {
          ...
          Number.isNaN(o) || i(this, s, o, "f");
        }
        static [((n = new WeakMap()), (s = new WeakMap()), Symbol.hasInstance)](
          e,
        ) {
          return (
            e instanceof o.Y &&
    ...
    51587: (e, t, r) => {
      ...
      e.exports = function (e) {
        ...
        return (
          void 0 === t &&
            console.warn(
              Error(n.format("humanize-ms(%j) result undefined", e)).stack,
            ),
          t
        );
      };
    ...
    57826: (e, t, r) => {
      ...
      let p = "RFC3986",
        ...
        y = (Object.prototype.hasOwnProperty, Array.isArray),
        b = (() => {
          let e = [];
          for (let t = 0; t < 256; ++t)
      ...
      let _ = Object.prototype.hasOwnProperty,
        ...
        R = {
          ...
          encoder: (e, t, r, n, s) => {
            ...
            let i = "";
            for (let e = 0; e < o.length; e += 1024) {
              let t = o.length >= 1024 ? o.slice(e, e + 1024) : o,
                r = [];
              for (let e = 0; e < t.length; ++e) {
                ...
                if (n < 2048) {
                  r[r.length] = b[192 | (n >> 6)] + b[128 | (63 & n)];
                  continue;
                }
                if (n < 55296 || n >= 57344) {
                  r[r.length] =
      ...
      class e9 {
        ...
        text() {
          return Promise.resolve(this[e6].toString());
        }
        arrayBuffer() {
          let e = this[e6];
        ...
        stream() {
          let e = new e4();
          return (e._read = function () {}), e.push(this[e6]), e.push(null), e;
        }
        toString() {
          return "[object Blob]";
        }
        slice() {
          let e,
            ...
            n = arguments[0],
            s = arguments[1];
          e = void 0 === n ? 0 : n < 0 ? Math.max(r + n, 0) : Math.min(n, r);
          let o = Math.max(
              (void 0 === s ? r : s < 0 ? Math.max(r + s, 0) : Math.min(s, r)) -
                e,
              0,
            ),
            i = this[e6].slice(e, e + o),
            a = new e9([], { type: arguments[2] });
          return (a[e6] = i), a;
        }
      }
      function e7(e, t, r) {
      ...
      Object.defineProperties(e9.prototype, {
        ...
        Object.defineProperty(e9.prototype, Symbol.toStringTag, {
          value: "Blob",
          writable: !1,
          enumerable: !1,
          configurable: !0,
        }),
        (e7.prototype = Object.create(Error.prototype)),
        (e7.prototype.constructor = e7),
        (e7.prototype.name = "FetchError");
      try {
        n = require("encoding").convert;
      } catch (e) {}
      ...
      function ta(e) {
        ...
        if (ts(e)) return "application/x-www-form-urlencoded;charset=UTF-8";
        if (to(e)) return e.type || null;
      ...
      (tr.prototype = {
        ...
        arrayBuffer() {
          return tn.call(this).then(function (e) {
            return e.buffer.slice(e.byteOffset, e.byteOffset + e.byteLength);
          });
        },
        blob() {
          let e = (this.headers && this.headers.get("content-type")) || "";
          return tn.call(this).then(function (t) {
            return Object.assign(new e9([], { type: e.toLowerCase() }), {
              [e6]: t,
            });
          });
        },
        ...
        textConverted() {
          ...
          return tn.call(this).then(function (t) {
            return (function (e, t) {
              ...
              let o = t.get("content-type"),
                i = "utf-8";
              return (
                o && (r = /charset=([^;]*)/i.exec(o)),
                (s = e.slice(0, 1024).toString()),
                !r && s && (r = /<meta.+?charset=(['"])(.+?)\1/i.exec(s)),
                !r &&
                  s &&
                  (!(r =
                ...
                !r && s && (r = /<\?xml.+?encoding=(['"])(.+?)\1/i.exec(s)),
                r &&
                  ("gb2312" === (i = r.pop()) || "gbk" === i) &&
                  (i = "gb18030"),
                n(e, "UTF-8", i).toString()
              );
            })(t, e.headers);
          });
        },
      ...
      class tm {
        constructor() {
          let e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : void 0;
          if (((this[tp] = Object.create(null)), e instanceof tm)) {
            let t = e.raw();
            for (let e of Object.keys(t)) for (let r of t[e]) this.append(e, r);
            return;
          }
          if (null == e);
        ...
        get(e) {
          td((e = `${e}`));
          let t = tf(this[tp], e);
          return void 0 === t ? null : this[tp][t].join(", ");
        }
        forEach(e) {
          let t =
          ...
          for (; n < r.length; ) {
            ...
            let o = s[0],
              i = s[1];
            e.call(t, i, o, this), (r = ty(this)), n++;
          }
        }
        set(e, t) {
          (e = `${e}`), (t = `${t}`), td(e), th(t);
          let r = tf(this[tp], e);
          this[tp][void 0 !== r ? r : e] = [t];
        }
        append(e, t) {
          (e = `${e}`), (t = `${t}`), td(e), th(t);
          let r = tf(this[tp], e);
          void 0 !== r ? this[tp][r].push(t) : (this[tp][e] = [t]);
        }
        has(e) {
          return td((e = `${e}`)), void 0 !== tf(this[tp], e);
        }
        delete(e) {
          td((e = `${e}`));
          let t = tf(this[tp], e);
          void 0 !== t && delete this[tp][t];
        }
        raw() {
          return this[tp];
        }
        ...
        values() {
          return tg(this, "value");
        }
        [Symbol.iterator]() {
          return tg(this, "key+value");
        }
      }
      function ty(e) {
        let t =
          ...
          .map(
            "key" === t
              ...
              : "value" === t
                ...
                : function (t) {
                    return [t.toLowerCase(), e[tp][t].join(", ")];
                  },
          );
      }
      ...
      let tb = Symbol("internal");
      function tg(e, t) {
        let r = Object.create(t_);
        return (r[tb] = { target: e, kind: t, index: 0 }), r;
      }
      let t_ = Object.setPrototypeOf(
        {
          next() {
            if (!this || Object.getPrototypeOf(this) !== t_)
            ...
            return n >= s.length
              ? { value: void 0, done: !0 }
              : ((this[tb].index = n + 1), { value: s[n], done: !1 });
          },
        },
        Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]())),
      );
      Object.defineProperty(t_, Symbol.toStringTag, {
        value: "HeadersIterator",
        writable: !1,
        enumerable: !1,
        configurable: !0,
      });
      let tw = Symbol("Response internals"),
        tv = e0.STATUS_CODES;
      class tS {
        constructor() {
          let e =
        ...
        get status() {
          return this[tw].status;
        }
        get ok() {
          return this[tw].status >= 200 && this[tw].status < 300;
        }
        get redirected() {
          return this[tw].counter > 0;
        }
        get statusText() {
          return this[tw].statusText;
        }
        get headers() {
          return this[tw].headers;
        }
        clone() {
          return new tS(ti(this), {
            url: this.url,
            status: this.status,
      ...
      tr.mixIn(tS.prototype),
        ...
        Object.defineProperty(tS.prototype, Symbol.toStringTag, {
          value: "Response",
          writable: !1,
          enumerable: !1,
          configurable: !0,
        });
      let tT = Symbol("Request internals"),
        tE = e1.URL || e2.URL,
        tR = e1.parse,
        tk = e1.format;
      function tx(e) {
        return (
          /^[a-zA-Z][a-zA-Z\d+\-.]*:/.exec(e) && (e = new tE(e).toString()),
          tR(e)
        );
      }
      let tP = "destroy" in eZ.Readable.prototype;
      function tA(e) {
        return "object" == typeof e && "object" == typeof e[tT];
      }
      class tC {
        constructor(e) {
          let t,
          ...
          tA(e)
            ? (t = tx(e.url))
            : ((t = e && e.href ? tx(e.href) : tx(`${e}`)), (e = {}));
          let n = r.method || e.method || "GET";
          if (
            ((n = n.toUpperCase()),
            (null != r.body || (tA(e) && null !== e.body)) &&
              ("GET" === n || "HEAD" === n))
          )
            throw TypeError("Request with GET/HEAD method cannot have body");
          let s =
            null != r.body ? r.body : tA(e) && null !== e.body ? ti(e) : null;
          tr.call(this, s, {
            timeout: r.timeout || e.timeout || 0,
            size: r.size || e.size || 0,
          });
          let o = new tm(r.headers || e.headers || {});
          if (null != s && !o.has("Content-Type")) {
            let e = ta(s);
            e && o.append("Content-Type", e);
          }
          let i = tA(e) ? e.signal : null;
          if (
        ...
        get method() {
          return this[tT].method;
        }
        get url() {
          return tk(this[tT].parsedURL);
        }
        get headers() {
          return this[tT].headers;
        }
        get redirect() {
          return this[tT].redirect;
        }
        get signal() {
          return this[tT].signal;
        }
        clone() {
          return new tC(this);
        }
      ...
      tr.mixIn(tC.prototype),
        ...
        (tO.prototype.name = "AbortError");
      let t$ = e1.URL || e2.URL,
        tj = eZ.PassThrough,
        tI = function (e, t) {
          let r = new t$(t).hostname,
            n = new t$(e).hostname;
          return (
            r === n || ("." === r[r.length - n.length - 1] && r.endsWith(n))
          );
        };
      function tq(e, t) {
        if (!tq.Promise)
        ...
        return (
          (tr.Promise = tq.Promise),
          new tq.Promise(function (r, n) {
            var s, o;
            let i,
              a,
              l = new tC(e, t),
              u = (function (e) {
                let t = e[tT].parsedURL,
                  r = new tm(e[tT].headers);
                if (
                ...
                if (e.signal && e.body instanceof eZ.Readable && !tP)
                  throw Error(
                ...
                return (
                  ...
                  Object.assign({}, t, {
                    method: e.method,
                    headers: (function (e) {
                      let t = Object.assign({ __proto__: null }, e[tp]),
                        r = tf(e[tp], "Host");
              ...
              c = ("https:" === u.protocol ? e3 : e0).request,
              d = l.signal,
              h = null,
              f = function () {
                let e = new tO("The user aborted a request.");
                n(e),
                  l.body && l.body instanceof eZ.Readable && tL(l.body, e),
                  h && h.body && h.body.emit("error", e);
              };
            if (d && d.aborted) return void f();
            let p = function () {
                f(), y();
              },
              m = c(u);
            function y() {
              m.abort(),
                d && d.removeEventListener("abort", p),
                clearTimeout(i);
            }
            d && d.addEventListener("abort", p),
              l.timeout &&
                m.once("socket", function (e) {
                  i = setTimeout(function () {
                    n(
                      new e7(`network timeout at: ${l.url}`, "request-timeout"),
                    ),
                      y();
                  }, l.timeout);
                }),
              m.on("error", function (e) {
                n(
                  ...
                  h && h.body && tL(h.body, e),
                  y();
              }),
              (s = m),
              (o = function (e) {
                (!d || !d.aborted) && h && h.body && tL(h.body, e);
              }),
                ...
                "chunked" !== t["transfer-encoding"] ||
                  ...
                  e.once("close", function (e) {
                    if (a && a.listenerCount("data") > 0 && !e) {
                      ...
                      (e.code = "ERR_STREAM_PREMATURE_CLOSE"), o(e);
                    }
                  });
              }),
              ...
              m.on("response", function (e) {
                        ...
                        for (let n of e[r])
                          tc.test(n) ||
                            (void 0 === t[tp][r]
                              ? (t[tp][r] = [n])
                              : t[tp][r].push(n));
                      else tc.test(e[r]) || (t[tp][r] = [e[r]]);
                  return t;
                })(e.headers);
                if (tq.isRedirect(e.statusCode)) {
                  let o = t.get("Location"),
                    i = null;
                  try {
                    i = null === o ? null : new t$(o, l.url).toString();
                  } catch (e) {
                    if ("manual" !== l.redirect) {
                      n(
                        new e7(
                          `uri requested responds with an invalid redirect URL: ${o}`,
                          "invalid-redirect",
                        ),
                      ),
                        y();
                  ...
                  switch (l.redirect) {
                    ...
                    case "follow":
                      ...
                      if (
                        !tI(l.url, i) ||
                        ((s = l.url), new t$(i).protocol !== new t$(s).protocol)
                      )
                        for (let e of [
                          "authorization",
                          "www-authenticate",
                ...
                if ("gzip" == u || "x-gzip" == u)
                  return void r(
                    (h = new tS((o = o.pipe(e8.createGunzip(c))), a)),
                  );
                  ...
                  t.once("data", function (e) {
                    r(
                      (h = new tS(
                        (o =
                          (15 & e[0]) == 8
                            ? o.pipe(e8.createInflate())
                            : o.pipe(e8.createInflateRaw())),
                        a,
                      )),
                    );
                  }),
                ...
                if ("br" == u && "function" == typeof e8.createBrotliDecompress)
                  return void r(
                    (h = new tS((o = o.pipe(e8.createBrotliDecompress())), a)),
                  );
                r((h = new tS(o, a)));
              });
            let b = l.body;
      ...
      (tq.isRedirect = function (e) {
        return 301 === e || 302 === e || 303 === e || 307 === e || 308 === e;
      }),
        (tq.Promise = global.Promise);
      var tB = r(28354),
        tM = r(47684),
        tW = r(60036),
        tF = r(28993);
      let tN = (e) => e instanceof tF.Y;
      var tD = r(86514);
      let tz = (0, tB.deprecate)(
        () => {},
      ...
      class tH {
        ...
        static [((C = new WeakMap()), (A = new WeakSet()), Symbol.hasInstance)](
          e,
        ) {
          return !!(
            e &&
        ...
        *entries() {
          for (let e of this.keys()) for (let t of this.getAll(e)) yield [e, t];
        }
        *values() {
        ...
        [((O = function ({
          ...
          if (s < 2)
            throw TypeError(
              `Failed to execute '${i}' on 'FormData': 2 arguments required, but only ${s} present.`,
            );
          if (((e = String(e)), (0, tW.f)(t)))
            o =
              void 0 === n
                ? t
                : new tM.Z([t], n, {
            ...
            o = new tM.Z([t], void 0 === n ? "blob" : n, { type: t.type });
          else if (n)
            throw TypeError(
              `Failed to execute '${i}' on 'FormData': parameter 2 is not of type 'Blob'.`,
            );
          else o = String(t);
          let a = tU(this, C, "f").get(e);
          if (!a || !r) return void tU(this, C, "f").set(e, [o]);
          a.push(o);
        }),
        Symbol.iterator)]() {
          return this.entries();
        ...
        forEach(e, t) {
          for (let [r, n] of this) e.call(t, n, r, this);
        }
        get [Symbol.toStringTag]() {
          return "FormData";
        }
      ...
      let t6 = { enableAdditionalHeaders: !1 };
      class t5 {
        constructor(e, t, r) {
          let n;
          if (
          ...
          if (
            (tG(t) ? (r = t) : (n = t), n || (n = tQ()), "string" != typeof n)
          )
          ...
          t8(this, W, e, "f"),
            t8(this, F, { ...t6, ...r }, "f"),
            t8(this, I, t4(this, B, "f").encode(t4(this, j, "f")), "f"),
            t8(this, q, t4(this, I, "f").byteLength, "f"),
            (this.boundary = `form-data-boundary-${n}`),
            (this.contentType = `multipart/form-data; boundary=${this.boundary}`),
            t8(
              this,
              M,
              t4(this, B, "f").encode(
                `${t4(this, L, "f")}${this.boundary}${t4(this, L, "f")}${t4(this, j, "f").repeat(2)}`,
              ),
              "f",
            ),
        ...
        getContentLength() {
          let e = 0;
          for (let [t, r] of t4(this, W, "f")) {
            let n = t2(r) ? r : t4(this, B, "f").encode(tZ(r));
            (e += t4(this, $, "m", N).call(this, t, n).byteLength),
              (e += t2(n) ? n.size : n.byteLength),
              (e += t4(this, q, "f"));
          }
          return e + t4(this, M, "f").byteLength;
        }
        *values() {
          for (let [e, t] of t4(this, W, "f").entries()) {
            let r = t2(t) ? t : t4(this, B, "f").encode(tZ(t));
            yield t4(this, $, "m", N).call(this, e, r),
              yield r,
              yield t4(this, I, "f");
          }
          yield t4(this, M, "f");
        ...
        (N = function (e, t) {
          let r = "";
          return (
            (r += `${t4(this, L, "f")}${this.boundary}${t4(this, j, "f")}Content-Disposition: form-data; name="${t0(e)}"`),
            t2(t) &&
              (r += `; filename="${t0(t.name)}"${t4(this, j, "f")}Content-Type: ${t.type || "application/octet-stream"}`),
            !0 === t4(this, F, "f").enableAdditionalHeaders &&
              (r += `${t4(this, j, "f")}Content-Length: ${t2(t) ? t.size : t.byteLength}`),
            t4(this, B, "f").encode(`${r}${t4(this, j, "f").repeat(2)}`)
          );
        }),
        Symbol.iterator)]() {
          return this.values();
      ...
      async function rr(e, ...t) {
        let { fileFromPath: n } = await r.e(3076).then(r.bind(r, 43076));
        return (
          rt ||
            (console.warn(
      ...
      let rn = new tV({ keepAlive: !0, timeout: 3e5 }),
        rs = new tV.HttpsAgent({ keepAlive: !0, timeout: 3e5 });
      async function ro(e, t) {
        let r = new t5(e),
          n = new t7(t9.Readable.from(r)),
          s = { ...t.headers, ...r.headers, "Content-Length": r.contentLength };
        return { ...t, body: n, headers: s };
      }
      let ri = () => {
        o ||
          (function (e, t = { auto: !1 }) {
            ...
            if (o)
              throw Error(
                `can't \`import 'openai/shims/${e.kind}'\` after \`import 'openai/shims/${o}'\``,
              );
            (P = t.auto),
              (o = e.kind),
              (i = e.fetch),
            ...
            ("undefined" == typeof AbortController &&
              (globalThis.AbortController = tJ.AbortController),
            {
              kind: "node",
              fetch: tq,
              Request: tC,
              ...
              getMultipartRequestOptions: ro,
              getDefaultAgent: (e) => (e.startsWith("https") ? rs : rn),
              fileFromPath: rr,
              isFsReadStream: (e) => e instanceof tX.ReadStream,
            }),
            { auto: !0 },
          );
      };
      ...
      class rl extends ra {
        constructor(e, t, r, n) {
          super(`${rl.makeMessage(e, t, r)}`),
            (this.status = e),
            (this.headers = n),
            (this.request_id = n?.["x-request-id"]),
            (this.error = t),
            (this.code = t?.code),
            (this.param = t?.param),
            (this.type = t?.type);
        ...
        static generate(e, t, r, n) {
          if (!e || !n) return new rc({ message: r, cause: r7(t) });
          let s = t?.error;
          return 400 === e
            ? new rh(e, s, r, n)
            : 401 === e
        ...
        decode(e) {
          ...
          let r =
              e instanceof ArrayBuffer
                ...
                : "string" == typeof e
                  ...
                  : e,
            n = new Uint8Array(this.buffer.length + r.length);
          ...
          for (
            ...
            (t = (function (e, t) {
              ...
              return null;
            })(this.buffer, rT(this, D, "f")));

          ) {
            if (t.carriage && null == rT(this, D, "f")) {
              rS(this, D, t.index, "f");
              continue;
            }
            if (
              null != rT(this, D, "f") &&
              (t.index !== rT(this, D, "f") + 1 || t.carriage)
            ) {
              s.push(
                this.decodeText(this.buffer.slice(0, rT(this, D, "f") - 1)),
              ),
                (this.buffer = this.buffer.slice(rT(this, D, "f"))),
                rS(this, D, null, "f");
              continue;
            }
            let e = null !== rT(this, D, "f") ? t.preceding - 1 : t.preceding,
      ...
      class rk {
              ...
              for await (let r of rx(e, t))
                if (!n) {
                  ...
                  if (
                    ...
                    if (t && t.error)
                      throw new rl(void 0, t.error, void 0, rY(e.headers));
                    yield t;
                  } else {
                    let e;
                    try {
        ...
        static fromReadableStream(e, t) {
          ...
          async function* n() {
            let t = new rE();
            for await (let r of rR(e)) for (let e of t.decode(r)) yield e;
            for (let e of t.flush()) yield e;
          }
          return new rk(async function* () {
            if (r)
              throw Error(
                "Cannot iterate over a consumed stream, use `.tee()` to split the stream.",
              );
        ...
        tee() {
          ...
          return [
            new rk(() => n(e), this.controller),
            new rk(() => n(t), this.controller),
          ];
        }
        toReadableStream() {
          let e,
          ...
          return new u({
            ...
            async pull(t) {
              try {
                let { value: n, done: s } = await e.next();
                if (s) return t.close();
                let o = r.encode(JSON.stringify(n) + "\n");
                t.enqueue(o);
              } catch (e) {
                t.error(e);
              }
      ...
      async function* rx(e, t) {
        ...
        let r = new rA(),
          n = new rE();
        for await (let t of rP(rR(e.body)))
      ...
      async function rI(e, t, r) {
        var n;
        if (rO((e = await e))) return e;
        if (rC(e)) {
          let n = await e.blob();
          t ||
            (t =
              new URL(e.url).pathname.split(/[\\/]/).pop() ?? "unknown_file");
          let s = r$(n) ? [await n.arrayBuffer()] : [n];
          return new l(s, t, r);
        }
        let s = await rq(e);
        if (
      ...
      async function rq(e) {
        ...
        if (
          ...
          t.push(e);
        else if (r$(e)) t.push(await e.arrayBuffer());
        else if (rB(e)) for await (let r of e) t.push(r);
        else
          throw Error(
      ...
      let rL = (e) =>
        ...
        rN = (e) => {
          if (rj(e)) return !0;
          if (Array.isArray(e)) return e.some(rN);
          if (e && "object" == typeof e) {
            for (let t in e) if (rN(e[t])) return !0;
          }
          return !1;
        },
        rD = async (e, t, r) => {
          if (void 0 !== r) {
            ...
            if (
              ...
              await Promise.all(
                Object.entries(r).map(([r, n]) => rD(e, `${t}[${r}]`, n)),
              );
            else
              throw TypeError(
      ...
      async function rH(e) {
        let { response: t } = e;
        if (e.options.stream)
          return (no("response", t.status, t.url, t.headers, t.body),
          e.options.__streamClass)
            ? e.options.__streamClass.fromSSEResponse(t, e.controller)
            : rk.fromSSEResponse(t, e.controller);
        ...
        if (n?.includes("application/json") || n?.endsWith("+json")) {
          let e = await t.json();
          return no("response", t.status, t.url, t.headers, e), rV(e, t);
        }
        let s = await t.text();
        return no("response", t.status, t.url, t.headers, s), s;
      }
      function rV(e, t) {
      ...
      class rJ extends Promise {
        ...
        _thenUnwrap(e) {
          return new rJ(this.responsePromise, async (t) =>
            rV(e(await this.parseResponse(t), t), t.response),
          );
        }
        asResponse() {
      ...
      class rX {
        constructor({
          ...
          (this.baseURL = e),
            (this.maxRetries = r9("maxRetries", t)),
            (this.timeout = r9("timeout", r)),
            (this.httpAgent = n),
            (this.fetch = s ?? i);
        }
        authHeaders(e) {
        ...
        defaultIdempotencyKey() {
          return `stainless-node-retry-${ni()}`;
        }
        get(e, t) {
        ...
        buildRequest(e, { retryCount: t = 0 } = {}) {
          let r = { ...e },
            { method: n, path: s, query: o, headers: i = {} } = r,
            a =
            ...
            u = this.buildURL(s, o);
          "timeout" in r && r9("timeout", r.timeout),
            (r.timeout = r.timeout ?? this.timeout);
          let c = r.httpAgent ?? this.httpAgent ?? d(u),
            h = r.timeout + 1e3;
        ...
        buildHeaders({
          ...
          return (
            nn(s, i),
            nn(s, t),
            rM(e.body) && "node" !== o && delete s["content-type"],
            void 0 === nu(i, "x-stainless-retry-count") &&
              void 0 === nu(t, "x-stainless-retry-count") &&
              (s["x-stainless-retry-count"] = String(n)),
            void 0 === nu(i, "x-stainless-timeout") &&
              void 0 === nu(t, "x-stainless-timeout") &&
              e.timeout &&
        ...
        makeStatusError(e, t, r, n) {
          return rl.generate(e, t, r, n);
        }
        request(e, t = null) {
          return new rJ(this.makeRequest(e, t));
        }
        async makeRequest(e, t) {
          let r = await e,
            n = r.maxRetries ?? this.maxRetries;
          null == t && (t = n), await this.prepareOptions(r);
          let {
            req: s,
            url: o,
            timeout: i,
          ...
          if (
            (await this.prepareRequest(s, { url: o, options: r }),
            no("request", o, r, s.headers),
            r.signal?.aborted)
          )
            throw new ru();
          let a = new AbortController(),
            l = await this.fetchWithTimeout(o, s, i, a).catch(r7);
          if (l instanceof Error) {
            if (r.signal?.aborted) throw new ru();
            if (t) return this.retryRequest(r, t);
            if ("AbortError" === l.name) throw new rd();
            throw new rc({ cause: l });
          }
          let u = rY(l.headers);
          if (!l.ok) {
            if (t && this.shouldRetry(l)) {
              ...
              return (
                no(`response (error; ${e})`, l.status, o, u),
                this.retryRequest(r, t, u)
              );
            }
            let e = await l.text().catch((e) => r7(e).message),
              n = r8(e),
              s = n ? void 0 : e,
              i = t
                ...
                : "(error; not retryable)";
            throw (
              (no(`response (error; ${i})`, l.status, o, u, s),
              this.makeStatusError(l.status, n, s, u))
            );
          }
          return { response: l, options: r, controller: a };
        }
        requestAPIList(e, t) {
          return new rQ(this, this.makeRequest(t, null), e);
        }
        buildURL(e, t) {
          let r = new URL(
              r6(e)
        ...
        async retryRequest(e, t, r) {
          ...
          return await r5(n), this.makeRequest(e, t - 1);
        }
        ...
        async getNextPage() {
          ...
          if ("params" in e && "object" == typeof t.query)
            ...
            for (let [r, n] of [
              ...
              e.url.searchParams.set(r, n);
            (t.query = void 0), (t.path = e.url.toString());
          }
          return await rU(this, z, "f").requestAPIList(this.constructor, t);
        }
        async *iterPages() {
          let e = this;
      ...
      let rY = (e) =>
            ...
            for (let { key: e, pattern: t } of [
              ...
              if (r) {
                let t = r[1] || 0,
                  n = r[2] || 0,
                  s = r[3] || 0;
                return { browser: e, version: `${t}.${n}.${s}` };
              }
            }
            return null;
          })();
        ...
        r4 = /^[a-z][a-z0-9+.-]*:/i,
        r6 = (e) => r4.test(e),
        r5 = (e) => new Promise((t) => setTimeout(t, e)),
        r9 = (e, t) => {
      ...
      function nn(e, t) {
        for (let r in t) {
          ...
          if (!n) continue;
          let s = t[r];
          null === s ? delete e[n] : void 0 !== s && (e[n] = s);
        }
      }
      let ns = new Set(["authorization", "api-key"]);
      function no(e, ...t) {
        "undefined" != typeof process &&
            ...
            ...t.map((e) => {
              ...
              if (e.headers) {
                ...
                for (let r in e.headers)
                  ns.has(r.toLowerCase()) && (t.headers[r] = "REDACTED");
                return t;
              }
              let t = null;
              for (let r in e)
      ...
      let ni = () =>
        ...
        nu = (e, t) => {
          ...
          if (nl(e)) {
            ...
            for (let s of [t, r, t.toUpperCase(), n]) {
              let t = e.get(s);
              if (t) return t;
            }
          }
          for (let [n, s] of Object.entries(e))
            if (n.toLowerCase() === r) {
              if (Array.isArray(s)) {
                ...
                return (
                  console.warn(
                    `Received ${s.length} entries for the ${t} header, using the first entry.`,
                  ),
                  s[0]
                );
              }
      ...
      class np extends nh {
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/chat/completions/${e}/messages`, n_, {
                query: t,
                ...r,
              });
        }
      ...
      class nb extends nh {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/chat/completions", ng, {
                query: e,
                ...t,
              });
        }
      ...
      class ng extends ny {}
      class n_ extends ny {}
      (nb.ChatCompletionsPage = ng), (nb.Messages = np);
      class nw extends nh {
        constructor() {
          super(...arguments), (this.completions = new nb(this._client));
        }
      }
      (nw.Completions = nb), (nw.ChatCompletionsPage = ng);
      class nv extends nh {
        create(e, t) {
          let r = !!e.encoding_format,
            n = r ? e.encoding_format : "base64";
          r &&
            no("Request", "User defined encoding_format:", e.encoding_format);
          let s = this._client.post("/embeddings", {
            body: { ...e, encoding_format: n },
            ...t,
          });
          return r
            ? s
            : (no("response", "Decoding base64 embeddings to float32 array"),
              s._thenUnwrap(
                (e) => (
                  e &&
                    e.data &&
      ...
      class nS extends nh {
        create(e, t) {
          return this._client.post("/files", rW({ body: e, ...t }));
        }
        retrieve(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/files", nT, { query: e, ...t });
        }
        del(e, t) {
        ...
        async waitForProcessing(
          ...
          let n = new Set(["processed", "error", "deleted"]),
            s = Date.now(),
            o = await this.retrieve(e);
          for (; !o.status || !n.has(o.status); )
            if ((await r5(t), (o = await this.retrieve(e)), Date.now() - s > r))
              throw new rd({
      ...
      class nT extends ny {}
      nS.FileObjectsPage = nT;
      class nE extends nh {
        createVariation(e, t) {
          return this._client.post("/images/variations", rW({ body: e, ...t }));
        }
        edit(e, t) {
          return this._client.post("/images/edits", rW({ body: e, ...t }));
        }
        generate(e, t) {
      ...
      class nx extends nh {
        create(e, t) {
          return this._client.post(
            "/audio/translations",
            rW({ body: e, ...t, __metadata: { model: e.model } }),
          );
        }
      }
      class nP extends nh {
        constructor() {
          super(...arguments),
            (this.transcriptions = new nk(this._client)),
            (this.translations = new nx(this._client)),
            (this.speech = new nR(this._client));
        }
      }
      (nP.Transcriptions = nk), (nP.Translations = nx), (nP.Speech = nR);
      class nA extends nh {
        create(e, t) {
      ...
      class nC extends nh {
        ...
        list(e) {
          return this._client.getAPIList("/models", nO, e);
        }
        del(e, t) {
      ...
      class nI extends nh {
        constructor() {
          super(...arguments), (this.graders = new nj(this._client));
        }
      }
      nI.Graders = nj;
      class nq extends nh {
      ...
      class nL extends nm {}
      nq.PermissionCreateResponsesPage = nL;
      class nB extends nh {
        constructor() {
          super(...arguments), (this.permissions = new nq(this._client));
        }
      }
      (nB.Permissions = nq), (nB.PermissionCreateResponsesPage = nL);
      class nM extends nh {
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
      ...
      class nW extends ny {}
      nM.FineTuningJobCheckpointsPage = nW;
      class nF extends nh {
        constructor() {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/fine_tuning/jobs", nN, {
                query: e,
                ...t,
              });
        }
        ...
        listEvents(e, t = {}, r) {
          return rZ(t)
            ? this.listEvents(e, {}, t)
            : this._client.getAPIList(`/fine_tuning/jobs/${e}/events`, nD, {
                query: t,
                ...r,
              });
        }
      ...
      class nN extends ny {}
      class nD extends ny {}
      (nF.FineTuningJobsPage = nN),
        (nF.FineTuningJobEventsPage = nD),
        (nF.Checkpoints = nM),
        (nF.FineTuningJobCheckpointsPage = nW);
      class nz extends nh {
        constructor() {
          super(...arguments),
            (this.methods = new n$(this._client)),
            (this.jobs = new nF(this._client)),
            (this.checkpoints = new nB(this._client)),
            (this.alpha = new nI(this._client));
        }
      }
      (nz.Methods = n$),
        (nz.Jobs = nF),
        (nz.FineTuningJobsPage = nN),
        (nz.FineTuningJobEventsPage = nD),
        (nz.Checkpoints = nB),
        (nz.Alpha = nI);
      class nU extends nh {}
      class nH extends nh {
        constructor() {
          super(...arguments), (this.graderModels = new nU(this._client));
        }
      }
      nH.GraderModels = nU;
      let nV = async (e) => {
        ...
        let n = [];
        for (let e of t) "fulfilled" === e.status && n.push(e.value);
        return n;
      };
      class nJ extends nh {
        create(e, t, r) {
        ...
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/vector_stores/${e}/files`, nX, {
                query: t,
                ...r,
                headers: { "OpenAI-Beta": "assistants=v2", ...r?.headers },
              });
        ...
        async poll(e, t, r) {
          ...
          for (
            ...
            switch (o.status) {
              case "in_progress":
                let i = 5e3;
                if (r?.pollIntervalMs) i = r.pollIntervalMs;
                else {
                  let e = s.response.headers.get("openai-poll-after-ms");
                  if (e) {
                    let t = parseInt(e);
                    isNaN(t) || (i = t);
                  }
      ...
      class nX extends ny {}
      class nK extends nm {}
      (nJ.VectorStoreFilesPage = nX), (nJ.FileContentResponsesPage = nK);
      class nQ extends nh {
        create(e, t, r) {
        ...
        async poll(e, t, r) {
          ...
          for (
            ...
            let { data: s, response: o } = await this.retrieve(e, t, {
              ...r,
              headers: n,
            }).withResponse();
            switch (s.status) {
              case "in_progress":
                ...
                if (r?.pollIntervalMs) i = r.pollIntervalMs;
                  ...
                  let e = o.headers.get("openai-poll-after-ms");
                  if (e) {
                    let t = parseInt(e);
                    isNaN(t) || (i = t);
                  }
        ...
        async uploadAndPoll(e, { files: t, fileIds: r = [] }, n) {
          ...
          let s = Math.min(n?.maxConcurrency ?? 5, t.length),
            o = this._client,
            i = t.values(),
            a = [...r];
          async function l(e) {
          ...
          let u = Array(s).fill(i).map(l);
          return await nV(u), await this.createAndPoll(e, { file_ids: a });
        }
      }
      class nY extends nh {
        constructor() {
          super(...arguments),
            (this.files = new nJ(this._client)),
            (this.fileBatches = new nQ(this._client));
        }
        create(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/vector_stores", nG, {
                query: e,
                ...t,
                headers: { "OpenAI-Beta": "assistants=v2", ...t?.headers },
              });
        ...
        search(e, t, r) {
          return this._client.getAPIList(`/vector_stores/${e}/search`, nZ, {
            body: t,
            method: "post",
            ...r,
            headers: { "OpenAI-Beta": "assistants=v2", ...r?.headers },
      ...
      class nG extends ny {}
      class nZ extends nm {}
      (nY.VectorStoresPage = nG),
        (nY.VectorStoreSearchResponsesPage = nZ),
        (nY.Files = nJ),
        (nY.VectorStoreFilesPage = nX),
        (nY.FileContentResponsesPage = nK),
        (nY.FileBatches = nQ);
      class n0 extends nh {
        create(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/assistants", n1, {
                query: e,
                ...t,
                headers: { "OpenAI-Beta": "assistants=v2", ...t?.headers },
              });
      ...
      n0.AssistantsPage = n1;
      let n3 = (e) => e?.role === "assistant",
        n8 = (e) => e?.role === "function",
        n4 = (e) => e?.role === "tool";
      var n6 = function (e, t, r, n, s) {
          if ("m" === n) throw TypeError("Private method is not writable");
          if ("a" === n && !s)
            throw TypeError("Private accessor was defined without a setter");
          if ("function" == typeof t ? e !== t || !s : !t.has(e))
      ...
      class n9 {
        ...
        _run(e) {
          setTimeout(() => {
            e().then(
              ...
              n5(this, U, "m", er).bind(this),
            );
          }, 0);
        }
        _connected() {
          this.ended || (n5(this, V, "f").call(this), this._emit("connect"));
        }
        get ended() {
          return n5(this, G, "f");
        }
        ...
        on(e, t) {
          return (
            (n5(this, Y, "f")[e] || (n5(this, Y, "f")[e] = [])).push({
              listener: t,
            }),
            this
          );
        ...
        async done() {
          n6(this, et, !0, "f"), await n5(this, X, "f");
        }
        _emit(e, ...t) {
          if (n5(this, G, "f")) return;
          "end" === e && (n6(this, G, !0, "f"), n5(this, K, "f").call(this));
          let r = n5(this, Y, "f")[e];
          if (
            (r &&
              ((n5(this, Y, "f")[e] = r.filter((e) => !e.once)),
              r.forEach(({ listener: e }) => e(...t))),
            "abort" === e)
          ) {
            let e = t[0];
            n5(this, et, "f") || r?.length || Promise.reject(e),
              n5(this, J, "f").call(this, e),
              n5(this, Q, "f").call(this, e),
              this._emit("end");
            return;
          }
          if ("error" === e) {
      ...
      function st(e, t) {
        let r = e.choices.map((e) => {
          var r, n;
          if ("length" === e.finish_reason) throw new rw();
      ...
      function sr(e) {
        return (
          !!n7(e.response_format) ||
          (e.tools?.some(
            (e) => se(e) || ("function" === e.type && !0 === e.function.strict),
          ) ??
            !1)
        );
      }
      (H = new WeakMap()),
        ...
        (er = function (e) {
          if (
            (n6(this, Z, !0, "f"),
            e instanceof Error && "AbortError" === e.name && (e = new ru()),
            e instanceof ru)
          )
            return n6(this, ee, !0, "f"), this._emit("abort", e);
      ...
      class ss extends n9 {
        ...
        _addMessage(e, t = !0) {
          if (
            ...
            if ((this._emit("message", e), (n8(e) || n4(e)) && e.content))
              this._emit("functionCallResult", e.content);
            else if (n3(e) && e.function_call)
              this._emit("functionCall", e.function_call);
            else if (n3(e) && e.tool_calls)
        ...
        async finalContent() {
          return await this.done(), sn(this, en, "m", es).call(this);
        }
        async finalMessage() {
          return await this.done(), sn(this, en, "m", eo).call(this);
        }
        async finalFunctionCall() {
          return await this.done(), sn(this, en, "m", ei).call(this);
        }
        async finalFunctionCallResult() {
          return await this.done(), sn(this, en, "m", ea).call(this);
        }
        async totalUsage() {
          return await this.done(), sn(this, en, "m", el).call(this);
        }
        allChatCompletions() {
        ...
        _emitFinal() {
          ...
          let t = sn(this, en, "m", eo).call(this);
          t && this._emit("finalMessage", t);
          let r = sn(this, en, "m", es).call(this);
          r && this._emit("finalContent", r);
          let n = sn(this, en, "m", ei).call(this);
          n && this._emit("finalFunctionCall", n);
          let s = sn(this, en, "m", ea).call(this);
          null != s && this._emit("finalFunctionCallResult", s),
            this._chatCompletions.some((e) => e.usage) &&
              this._emit("totalUsage", sn(this, en, "m", el).call(this));
        }
        async _createChatCompletion(e, t, r) {
          ...
          n &&
            ...
            sn(this, en, "m", eu).call(this, t);
          let s = await e.chat.completions.create(
            { ...t, stream: !1 },
            { ...r, signal: this.controller.signal },
          );
          return this._connected(), this._addChatCompletion(st(s, t));
        }
        ...
        async _runFunctions(e, t, r) {
          let n = "function",
            { function_call: s = "auto", stream: o, ...i } = t,
            a = "string" != typeof s && s?.name,
          ...
          for (let t = 0; t < l; ++t) {
            let t,
              o = await this._createChatCompletion(
                e,
                {
                  ...i,
                  function_call: s,
              ...
              l = o.choices[0]?.message;
            if (!l) throw new ra("missing message in ChatCompletion response");
            if (!l.function_call) return;
            let { name: d, arguments: h } = l.function_call,
              f = u[d];
            if (f) {
              if (a && a !== d) {
                let e = `Invalid function_call: ${JSON.stringify(d)}. ${JSON.stringify(a)} requested. Please try again`;
                this._addMessage({ role: n, name: d, content: e });
                continue;
              }
            } else {
              let e = `Invalid function_call: ${JSON.stringify(d)}. Available options are: ${c.map((e) => JSON.stringify(e.name)).join(", ")}. Please try again`;
              this._addMessage({ role: n, name: d, content: e });
              continue;
            }
            try {
              t = n2(f) ? await f.parse(h) : h;
            } catch (e) {
              this._addMessage({
                role: n,
                name: d,
            ...
            let p = await f.function(t, this),
              m = sn(this, en, "m", ec).call(this, p);
            if ((this._addMessage({ role: n, name: d, content: m }), a)) return;
          }
        }
        async _runTools(e, t, r) {
          let n = "tool",
            { tool_choice: s = "auto", stream: o, ...i } = t,
            a = "string" != typeof s && s?.function?.name,
            { maxChatCompletions: l = 10 } = r || {},
            u = t.tools.map((e) => {
              if (se(e)) {
                if (!e.$callback)
          ...
          for (let t = 0; t < l; ++t) {
            let t = await this._createChatCompletion(
              ...
              o = t.choices[0]?.message;
            if (!o) throw new ra("missing message in ChatCompletion response");
            if (!o.tool_calls?.length) break;
            for (let e of o.tool_calls) {
              let t;
              if ("function" !== e.type) continue;
              let r = e.id,
                { name: s, arguments: o } = e.function,
                i = c[s];
              if (i) {
                if (a && a !== s) {
                  let e = `Invalid tool_call: ${JSON.stringify(s)}. ${JSON.stringify(a)} requested. Please try again`;
                  this._addMessage({ role: n, tool_call_id: r, content: e });
                  continue;
                }
              } else {
                let e = `Invalid tool_call: ${JSON.stringify(s)}. Available options are: ${Object.keys(
                  c,
                )
              ...
              let l = await i.function(t, this),
                u = sn(this, en, "m", ec).call(this, l);
              if (
                (this._addMessage({ role: n, tool_call_id: r, content: u }), a)
              )
                return;
            }
          }
      ...
      (en = new WeakSet()),
        (es = function () {
          return sn(this, en, "m", eo).call(this).content ?? null;
        }),
        (eo = function () {
        ...
        (ei = function () {
          for (let e = this.messages.length - 1; e >= 0; e--) {
            let t = this.messages[e];
            if (n3(t) && t?.function_call) return t.function_call;
            if (n3(t) && t?.tool_calls?.length)
      ...
      class so extends ss {
        static runFunctions(e, t, r) {
          ...
          return n._run(() => n._runFunctions(e, t, s)), n;
        }
        static runTools(e, t, r) {
          ...
          return n._run(() => n._runTools(e, t, s)), n;
        }
        _addMessage(e, t = !0) {
          super._addMessage(e, t),
            n3(e) && e.content && this._emit("content", e.content);
        }
      }
      let si = {
        STR: 1,
      ...
      let su = (e, t) => {
          let r = e.length,
            n = 0,
            s = (e) => {
              throw new sa(`${e} at position ${n}`);
            },
            o = (e) => {
              throw new sl(`${e} at position ${n}`);
            },
            i = () =>
              (d(), n >= r && s("Unexpected end of input"), '"' === e[n])
                ? a()
                : "{" === e[n]
                  ? l()
                  : "[" === e[n]
            ...
            a = () => {
              let i = n,
                a = !1;
              for (n++; n < r && ('"' !== e[n] || (a && "\\" === e[n - 1])); )
                (a = "\\" === e[n] && !a), n++;
              if ('"' == e.charAt(n))
                try {
                  return JSON.parse(e.substring(i, ++n - Number(a)));
                } catch (e) {
                  o(String(e));
                }
              else if (si.STR & t)
            ...
            u = () => {
              ...
              let r = [];
              try {
                for (; "]" !== e[n]; ) r.push(i()), d(), "," === e[n] && n++;
              } catch (e) {
                if (si.ARR & t) return r;
            ...
            c = () => {
              ...
              n != r || si.NUM & t || s("Unterminated number literal");
              try {
                return JSON.parse(e.substring(i, n));
              } catch (r) {
                "-" === e.substring(i, n) &&
                  si.NUM & t &&
                  s("Not sure what '-' is");
      ...
      class sf extends ss {
        ...
        async _createChatCompletion(e, t, r) {
          ...
          n &&
            (n.aborted && this.controller.abort(),
            n.addEventListener("abort", () => this.controller.abort())),
            sh(this, ed, "m", em).call(this);
          let s = await e.chat.completions.create(
            { ...t, stream: !0 },
            { ...r, signal: this.controller.signal },
          );
          for await (let e of (this._connected(), s))
            sh(this, ed, "m", eb).call(this, e);
          if (s.controller.signal?.aborted) throw new ru();
          return this._addChatCompletion(sh(this, ed, "m", ew).call(this));
        }
        async _fromReadableStream(e, t) {
          ...
          n &&
            ...
            sh(this, ed, "m", em).call(this),
            this._connected();
          let s = rk.fromReadableStream(e, this.controller);
          for await (let e of s)
            r &&
              r !== e.id &&
              this._addChatCompletion(sh(this, ed, "m", ew).call(this)),
              sh(this, ed, "m", eb).call(this, e),
              (r = e.id);
          if (s.controller.signal?.aborted) throw new ru();
          return this._addChatCompletion(sh(this, ed, "m", ew).call(this));
        ...
        (ed = new WeakSet()),
        (em = function () {
          this.ended || sd(this, ep, void 0, "f");
        }),
        (ey = function (e) {
          let t = sh(this, ef, "f")[e.index];
          return (
            t ||
              ((t = {
                content_done: !1,
              ...
              (sh(this, ef, "f")[e.index] = t)),
            t
          );
        }),
        (eb = function (e) {
          if (this.ended) return;
          let t = sh(this, ed, "m", eS).call(this, e);
          for (let r of (this._emit("chunk", e, t), e.choices)) {
            ...
            let n = sh(this, ed, "m", ey).call(this, e);
            for (let t of (e.finish_reason &&
              (sh(this, ed, "m", e_).call(this, e),
              null != n.current_tool_call_index &&
                sh(this, ed, "m", eg).call(this, e, n.current_tool_call_index)),
            r.delta.tool_calls ?? []))
              n.current_tool_call_index !== t.index &&
                (sh(this, ed, "m", e_).call(this, e),
                null != n.current_tool_call_index &&
                  sh(this, ed, "m", eg).call(
                    this,
                    e,
        ...
        (e_ = function (e) {
          let t = sh(this, ed, "m", ey).call(this, e);
          if (e.message.content && !t.content_done) {
            t.content_done = !0;
            let r = sh(this, ed, "m", ev).call(this);
                ...
                (r = {
                  ...
                  choices: s.map(
                    ({
                      ...
                      if (!r)
                        throw new ra(`missing finish_reason for choice ${n}`);
                      let {
                          content: i = null,
                          function_call: a,
                          tool_calls: l,
                        ...
                        c = t.role;
                      if (!c) throw new ra(`missing role for choice ${n}`);
                      if (a) {
                        ...
                        ? {
                            ...
                            message: {
                              ...
                              tool_calls: l.map((t, r) => {
                                let { function: s, type: o, id: i, ...a } = t,
                                  { arguments: l, name: u, ...c } = s || {};
                                if (null == i)
                                  throw new ra(`missing choices[${n}].tool_calls[${r}].id
${sp(e)}`);
                                if (null == o)
                                  throw new ra(`missing choices[${n}].tool_calls[${r}].type
${sp(e)}`);
                                if (null == u)
                                  throw new ra(`missing choices[${n}].tool_calls[${r}].function.name
${sp(e)}`);
                                if (null == l)
                                  throw new ra(`missing choices[${n}].tool_calls[${r}].function.arguments
${sp(e)}`);
                                return {
                                  ...a,
                                  id: i,
        ...
        (ev = function () {
          let e = sh(this, eh, "f")?.response_format;
          return n7(e) ? e : null;
        }),
        (eS = function (e) {
          var t, r, n, s;
          ...
          e.choices)) {
            ...
            if (
              ...
              if (e.logprobs) {
                let { content: n, refusal: s, ...o } = c;
                Object.assign(e.logprobs, o),
                  n &&
                    ((t = e.logprobs).content ?? (t.content = []),
                    e.logprobs.content.push(...n)),
                  s &&
                    ((r = e.logprobs).refusal ?? (r.refusal = []),
                    e.logprobs.refusal.push(...s));
              } else e.logprobs = Object.assign({}, c);
            if (
              l &&
              ((e.finish_reason = l),
              sh(this, eh, "f") && sr(sh(this, eh, "f")))
            ) {
              if ("length" === l) throw new rw();
            ...
            if (
              ...
              f &&
                (e.message.function_call
                  ? (f.name && (e.message.function_call.name = f.name),
                    f.arguments &&
                      ((n = e.message.function_call).arguments ??
                        (n.arguments = ""),
                      (e.message.function_call.arguments += f.arguments)))
                  : (e.message.function_call = f)),
              a &&
                ((e.message.content = (e.message.content || "") + a),
                !e.message.refusal &&
                  sh(this, ed, "m", ev).call(this) &&
                  (e.message.parsed = sc(e.message.content))),
              m)
            )
              for (let { index: t, id: r, type: n, function: o, ...i } of (e
                .message.tool_calls || (e.message.tool_calls = []),
              m)) {
                let a = (s = e.message.tool_calls)[t] ?? (s[t] = {});
                Object.assign(a, i),
                  r && (a.id = r),
                  n && (a.type = n),
                  o &&
                    (a.function ??
                      (a.function = { name: o.name ?? "", arguments: "" })),
                  o?.name && (a.function.name = o.name),
                  o?.arguments &&
                    ((a.function.arguments += o.arguments),
                    (function (e, t) {
                      if (!e) return !1;
                      let r = e.tools?.find(
                        (e) => e.function?.name === t.function.name,
                      );
                      return se(r) || r?.function.strict || !1;
                    })(sh(this, eh, "f"), a) &&
                      (a.function.parsed_arguments = sc(a.function.arguments)));
              }
          }
          return o;
        }),
      ...
      class sy extends nh {
        parse(e, t) {
          ...
          return this._client.chat.completions
            ...
            ._thenUnwrap((t) => st(t, e));
        }
        runFunctions(e, t) {
          return e.stream
            ? sm.runFunctions(this._client, e, t)
            : so.runFunctions(this._client, e, t);
        }
        runTools(e, t) {
          return e.stream
            ? sm.runTools(this._client, e, t)
            : so.runTools(this._client, e, t);
        }
        stream(e, t) {
          return sf.createChatCompletion(this._client, e, t);
        }
      }
      class sb extends nh {
        constructor() {
      ...
      class sw extends nh {
        constructor() {
          super(...arguments),
            (this.sessions = new sg(this._client)),
            (this.transcriptionSessions = new s_(this._client));
        }
      }
      (sw.Sessions = sg), (sw.TranscriptionSessions = s_);
      ...
      class sT extends n9 {
        ...
        async _fromReadableStream(e, t) {
          ...
          r &&
            ...
            this._connected();
          let n = rk.fromReadableStream(e, this.controller);
          for await (let e of n) sv(this, eT, "m", eL).call(this, e);
          if (n.controller.signal?.aborted) throw new ru();
          return this._addRun(sv(this, eT, "m", eB).call(this));
        }
        toReadableStream() {
          return new rk(
            this[Symbol.asyncIterator].bind(this),
        ...
        static createToolAssistantStream(e, t, r, n, s) {
          let o = new sT();
          return (
            o._run(() =>
              o._runToolAssistantStream(e, t, r, n, {
                ...s,
                headers: {
                  ...s?.headers,
                  "X-Stainless-Helper-Method": "stream",
        ...
        async _createToolAssistantStream(e, t, r, n, s) {
          let o = s?.signal;
          o &&
            (o.aborted && this.controller.abort(),
            o.addEventListener("abort", () => this.controller.abort()));
          let i = { ...n, stream: !0 },
            a = await e.submitToolOutputs(t, r, i, {
              ...s,
              signal: this.controller.signal,
            });
          for await (let e of (this._connected(), a))
            sv(this, eT, "m", eL).call(this, e);
          if (a.controller.signal?.aborted) throw new ru();
          return this._addRun(sv(this, eT, "m", eB).call(this));
        }
        ...
        async finalRunSteps() {
          return await this.done(), Object.values(sv(this, eR, "f"));
        }
        async finalMessages() {
          return await this.done(), Object.values(sv(this, ek, "f"));
        }
        async finalRun() {
          if ((await this.done(), !sv(this, eP, "f")))
        ...
        async _createThreadAssistantStream(e, t, r) {
          ...
          n &&
            ...
            n.addEventListener("abort", () => this.controller.abort()));
          let s = { ...t, stream: !0 },
            o = await e.createAndRun(s, {
              ...r,
              signal: this.controller.signal,
            });
          for await (let e of (this._connected(), o))
            sv(this, eT, "m", eL).call(this, e);
          if (o.controller.signal?.aborted) throw new ru();
          return this._addRun(sv(this, eT, "m", eB).call(this));
        }
        async _createAssistantStream(e, t, r, n) {
          ...
          let o = { ...r, stream: !0 },
            i = await e.create(t, o, { ...n, signal: this.controller.signal });
          for await (let e of (this._connected(), i))
            sv(this, eT, "m", eL).call(this, e);
          if (i.controller.signal?.aborted) throw new ru();
          return this._addRun(sv(this, eT, "m", eB).call(this));
        }
        static accumulateDelta(e, t) {
          for (let [r, n] of Object.entries(t)) {
            ...
            else if (nd(t) && nd(n)) t = this.accumulateDelta(t, n);
        ...
        async _runToolAssistantStream(e, t, r, n, s) {
          return await this._createToolAssistantStream(r, e, t, n, s);
        }
      }
      (eL = function (e) {
        if (!this.ended)
          switch (
            (sS(this, ej, e, "f"), sv(this, eT, "m", eF).call(this, e), e.event)
          ) {
            case "thread.created":
              break;
        ...
        (eM = function (e) {
          let [t, r] = sv(this, eT, "m", eD).call(this, e, sv(this, ex, "f"));
          for (let e of (sS(this, ex, t, "f"),
          (sv(this, ek, "f")[t.id] = t),
          r)) {
            ...
            case "thread.message.delta":
              if (
                ...
                for (let r of e.data.delta.content) {
                  ...
                  if (r.index != sv(this, eA, "f")) {
                    if (sv(this, eC, "f"))
                      switch (sv(this, eC, "f").type) {
                        case "text":
                          this._emit(
                            "textDone",
                            sv(this, eC, "f").text,
                        ...
                        case "image_file":
                          this._emit(
                            "imageFileDone",
                            sv(this, eC, "f").image_file,
                            sv(this, ex, "f"),
                          );
                      }
                    sS(this, eA, r.index, "f");
                  }
                  sS(this, eC, t.content[r.index], "f");
                }
              break;
            case "thread.message.completed":
            case "thread.message.incomplete":
              if (void 0 !== sv(this, eA, "f")) {
                let t = e.data.content[sv(this, eA, "f")];
                if (t)
                  switch (t.type) {
                    case "image_file":
                      this._emit(
                      ...
                      break;
                    case "text":
                      this._emit("textDone", t.text, sv(this, ex, "f"));
                  }
              }
              sv(this, ex, "f") && this._emit("messageDone", e.data),
                sS(this, ex, void 0, "f");
          }
        }),
        (eW = function (e) {
          let t = sv(this, eT, "m", eN).call(this, e);
          switch ((sS(this, eq, t, "f"), e.event)) {
            case "thread.run.step.created":
              ...
              if (
                ...
                for (let e of r.step_details.tool_calls)
                  e.index == sv(this, eO, "f")
                    ...
                    : (sv(this, e$, "f") &&
                        this._emit("toolCallDone", sv(this, e$, "f")),
                      sS(this, eO, e.index, "f"),
                      sS(this, e$, t.step_details.tool_calls[e.index], "f"),
                      sv(this, e$, "f") &&
                        this._emit("toolCallCreated", sv(this, e$, "f")));
        ...
        (eF = function (e) {
          sv(this, eE, "f").push(e), this._emit("event", e);
        }),
        (eN = function (e) {
          switch (e.event) {
            case "thread.run.step.created":
              return (sv(this, eR, "f")[e.data.id] = e.data), e.data;
            case "thread.run.step.delta":
              let t = sv(this, eR, "f")[e.data.id];
              if (!t)
                throw Error(
              ...
              let r = e.data;
              if (r.delta) {
                let n = sT.accumulateDelta(t, r.delta);
                sv(this, eR, "f")[e.data.id] = n;
              }
              return sv(this, eR, "f")[e.data.id];
            case "thread.run.step.completed":
            case "thread.run.step.failed":
            case "thread.run.step.cancelled":
            case "thread.run.step.expired":
            case "thread.run.step.in_progress":
              sv(this, eR, "f")[e.data.id] = e.data;
          }
          if (sv(this, eR, "f")[e.data.id]) return sv(this, eR, "f")[e.data.id];
              ...
              if (n.delta.content)
                for (let e of n.delta.content)
                  if (e.index in t.content) {
                    let r = t.content[e.index];
                    t.content[e.index] = sv(this, eT, "m", ez).call(this, e, r);
        ...
        (ez = function (e, t) {
          return sT.accumulateDelta(t, e);
        }),
        (eU = function (e) {
          switch ((sS(this, eI, e.data, "f"), e.event)) {
            case "thread.run.created":
            case "thread.run.queued":
            case "thread.run.in_progress":
              break;
      ...
      class sE extends nh {
        ...
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/threads/${e}/messages`, sR, {
                query: t,
                ...r,
                headers: { "OpenAI-Beta": "assistants=v2", ...r?.headers },
              });
      ...
      class sk extends nh {
        ...
        list(e, t, r = {}, n) {
          return rZ(r)
            ? this.list(e, t, {}, r)
            : this._client.getAPIList(`/threads/${e}/runs/${t}/steps`, sx, {
                query: r,
                ...n,
                headers: { "OpenAI-Beta": "assistants=v2", ...n?.headers },
              });
      ...
      class sP extends nh {
        constructor() {
          super(...arguments), (this.steps = new sk(this._client));
        }
        create(e, t, r) {
          let { include: n, ...s } = t;
        ...
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/threads/${e}/runs`, sA, {
                query: t,
                ...r,
                headers: { "OpenAI-Beta": "assistants=v2", ...r?.headers },
              });
        ...
        createAndStream(e, t, r) {
          return sT.createAssistantStream(
            e,
        ...
        async submitToolOutputsAndPoll(e, t, r, n) {
          let s = await this.submitToolOutputs(e, t, r, n);
          return await this.poll(e, s.id, n);
        }
        submitToolOutputsStream(e, t, r, n) {
          return sT.createToolAssistantStream(
            e,
            t,
            this._client.beta.threads.runs,
            r,
      ...
      class sA extends ny {}
      (sP.RunsPage = sA), (sP.Steps = sk), (sP.RunStepsPage = sx);
      class sC extends nh {
        constructor() {
          super(...arguments),
            (this.runs = new sP(this._client)),
            (this.messages = new sE(this._client));
        }
        create(e = {}, t) {
          return rZ(e)
            ? this.create({}, e)
        ...
        createAndRunStream(e, t) {
          return sT.createThreadAssistantStream(
            e,
      ...
      class sO extends nh {
        constructor() {
          super(...arguments),
            (this.realtime = new sw(this._client)),
            (this.chat = new sb(this._client)),
            (this.assistants = new n0(this._client)),
            (this.threads = new sC(this._client));
        }
      }
      (sO.Realtime = sw),
        (sO.Assistants = n0),
        (sO.AssistantsPage = n1),
        (sO.Threads = sC);
      class s$ extends nh {
        create(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/batches", sj, { query: e, ...t });
        }
        cancel(e, t) {
      ...
      class sq extends nh {
        constructor() {
          super(...arguments), (this.parts = new sI(this._client));
        }
        create(e, t) {
      ...
      function sL(e, t) {
        ...
        return (
          Object.getOwnPropertyDescriptor(e, "output_text") || sB(n),
      ...
      class sM extends nh {
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/responses/${e}/input_items`, sz, {
                query: t,
                ...r,
              });
        }
      }
      var sW = function (e, t, r, n, s) {
          if ("m" === n) throw TypeError("Private method is not writable");
          if ("a" === n && !s)
            throw TypeError("Private accessor was defined without a setter");
          if ("function" == typeof t ? e !== t || !s : !t.has(e))
      ...
      class sN extends n9 {
        ...
        async _createOrRetrieveResponse(e, t, r) {
          ...
          s &&
            (s.aborted && this.controller.abort(),
            s.addEventListener("abort", () => this.controller.abort())),
            sF(this, eH, "m", eK).call(this);
          let o = null;
          for await (let s of ("response_id" in t
            ? ((n = await e.responses.retrieve(
                t.response_id,
                { stream: !0 },
                { ...r, signal: this.controller.signal, stream: !0 },
              )),
              (o = t.starting_after ?? null))
          ...
          this._connected(),
          n))
            sF(this, eH, "m", eQ).call(this, s, o);
          if (n.controller.signal?.aborted) throw new ru();
          return sF(this, eH, "m", eY).call(this);
        }
        [((eV = new WeakMap()),
        (eJ = new WeakMap()),
        (eX = new WeakMap()),
        (eH = new WeakSet()),
        (eK = function () {
          this.ended || sW(this, eJ, void 0, "f");
        }),
        (eQ = function (e, t) {
          if (this.ended) return;
          let r = (e, r) => {
            ...
            n = sF(this, eH, "m", eG).call(this, e);
          switch ((r("event", e), e.type)) {
            case "response.output_text.delta": {
              let t = n.output[e.output_index];
              if (!t) throw new ra(`missing output at index ${e.output_index}`);
              if ("message" === t.type) {
        ...
        (eG = function (e) {
          ...
          if (!t) {
            ...
            return sW(this, eJ, e.response, "f");
          }
          switch (e.type) {
            ...
            case "response.content_part.added": {
              ...
              if (!r) throw new ra(`missing output at index ${e.output_index}`);
      ...
      class sD extends nh {
        constructor() {
          super(...arguments), (this.inputItems = new sM(this._client));
        }
        create(e, t) {
          return this._client
            .post("/responses", { body: e, ...t, stream: e.stream ?? !1 })
            ._thenUnwrap(
              (e) => ("object" in e && "response" === e.object && sB(e), e),
            );
        }
        retrieve(e, t = {}, r) {
        ...
        parse(e, t) {
          return this._client.responses
            .create(e, t)
            ._thenUnwrap((t) => sL(t, e));
        }
        stream(e, t) {
          return sN.createResponse(this._client, e, t);
        }
        cancel(e, t) {
      ...
      class sH extends ny {}
      sU.OutputItemListResponsesPage = sH;
      class sV extends nh {
        constructor() {
          super(...arguments), (this.outputItems = new sU(this._client));
        }
        create(e, t, r) {
        ...
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/evals/${e}/runs`, sJ, {
                query: t,
                ...r,
              });
        }
      ...
      class sJ extends ny {}
      (sV.RunListResponsesPage = sJ),
        (sV.OutputItems = sU),
        (sV.OutputItemListResponsesPage = sH);
      class sX extends nh {
        constructor() {
          super(...arguments), (this.runs = new sV(this._client));
        }
        create(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/evals", sK, { query: e, ...t });
        }
        del(e, t) {
      ...
      class sK extends ny {}
      (sX.EvalListResponsesPage = sK),
        (sX.Runs = sV),
        (sX.RunListResponsesPage = sJ);
      class sQ extends nh {
        retrieve(e, t, r) {
      ...
      class sY extends nh {
        constructor() {
          super(...arguments), (this.content = new sQ(this._client));
        }
        create(e, t, r) {
          return this._client.post(
            `/containers/${e}/files`,
        ...
        list(e, t = {}, r) {
          return rZ(t)
            ? this.list(e, {}, t)
            : this._client.getAPIList(`/containers/${e}/files`, sG, {
                query: t,
                ...r,
              });
        }
      ...
      class sG extends ny {}
      (sY.FileListResponsesPage = sG), (sY.Content = sQ);
      class sZ extends nh {
        constructor() {
          super(...arguments), (this.files = new sY(this._client));
        }
        create(e, t) {
        ...
        list(e = {}, t) {
          return rZ(e)
            ? this.list({}, e)
            : this._client.getAPIList("/containers", s0, { query: e, ...t });
        }
        del(e, t) {
      ...
      class s0 extends ny {}
      (sZ.ContainerListResponsesPage = s0),
        (sZ.Files = sY),
        (sZ.FileListResponsesPage = sG);
      class s1 extends rX {
        constructor({
          baseURL: e = ne("OPENAI_BASE_URL"),
          apiKey: t = ne("OPENAI_API_KEY"),
          organization: r = ne("OPENAI_ORG_ID") ?? null,
          project: n = ne("OPENAI_PROJECT_ID") ?? null,
          ...s
        } = {}) {
          if (void 0 === t)
            throw new ra(
          ...
          if (!o.dangerouslyAllowBrowser && na())
            throw new ra(
          ...
          super({
            ...
            (this.completions = new nf(this)),
            (this.chat = new nw(this)),
            (this.embeddings = new nv(this)),
            (this.files = new nS(this)),
            (this.images = new nE(this)),
            (this.audio = new nP(this)),
            (this.moderations = new nA(this)),
            (this.models = new nC(this)),
            (this.fineTuning = new nz(this)),
            (this.graders = new nH(this)),
            (this.vectorStores = new nY(this)),
            (this.beta = new sO(this)),
            (this.batches = new s$(this)),
            (this.uploads = new sq(this)),
            (this.responses = new sD(this)),
            (this.evals = new sX(this)),
            (this.containers = new sZ(this)),
            (this._options = o),
            (this.apiKey = t),
            (this.organization = r),
            (this.project = n);
        ...
        stringifyQuery(e) {
          return (function (e, t = {}) {
              ...
              o = (function (e = R) {
                ...
                if (
                  (("function" == typeof e.filter || v(e.filter)) &&
                    (o = e.filter),
                  (t =
                    e.arrayFormat && e.arrayFormat in w
                      ? e.arrayFormat
                      : "indices" in e
                        ? e.indices
                          ? "indices"
                ...
                let i =
                  void 0 === e.allowDots
                    ? !0 == !!e.encodeDotInKeys || R.allowDots
                    : !!e.allowDots;
                return {
                  addQueryPrefix:
                  ...
                  encodeDotInKeys:
                    "boolean" == typeof e.encodeDotInKeys
                      ...
                      : R.encodeDotInKeys,
                  encoder:
                    "function" == typeof e.encoder ? e.encoder : R.encoder,
                  encodeValuesOnly:
            ...
            "function" == typeof o.filter
              ? (s = (0, o.filter)("", s))
              : v(o.filter) && (r = o.filter);
            let i = [];
            if ("object" != typeof s || null === s) return "";
            let a = w[o.arrayFormat],
              l = "comma" === a && o.commaRoundTrip;
            r || (r = Object.keys(s)), o.sort && r.sort(o.sort);
            let u = new WeakMap();
            for (let e = 0; e < r.length; ++e) {
              let t = r[e];
              (o.skipNulls && null === s[t]) ||
                T(
                  i,
                  (function e(
                    t,
                    ...
                    let E,
                      ...
                      A = 0,
                      C = !1;
                    for (; void 0 !== (P = P.get(k)) && !C; ) {
                      let e = P.get(t);
                      if (((A += 1), void 0 !== e))
                        if (e === A) throw RangeError("Cyclic object value");
                        else C = !0;
                      void 0 === P.get(k) && (A = 0);
                    }
                    if (
                      ...
                      if (i) return u && !y ? u(r, R.encoder, b, "key", p) : r;
                      x = "";
                    }
                    if (
                      "string" == typeof (w = x) ||
                      ...
                      if (u) {
                        let e = y ? r : u(r, R.encoder, b, "key", p);
                        return [
                          m?.(e) + "=" + m?.(u(x, R.encoder, b, "value", p)),
                        ];
                      }
                    ...
                    let $ = l ? String(r).replace(/\./g, "%2E") : String(r),
                      j = s && v(x) && 1 === x.length ? $ + "[]" : $;
                    if (o && v(x) && 0 === x.length) return j + "[]";
                    for (let r = 0; r < E.length; ++r) {
                      let g = E[r],
                        w =
                          "object" == typeof g && void 0 !== g.value
                            ? g.value
                            : x[g];
                      if (a && null === w) continue;
                      let S = h && l ? g.replace(/\./g, "%2E") : g,
                        R = v(x)
                          ? "function" == typeof n
                            ? n(j, S)
                            : j
      ...
      (s1.OpenAI = s1),
        (s1.DEFAULT_TIMEOUT = 6e5),
        (s1.OpenAIError = ra),
        (s1.APIError = rl),
        (s1.APIConnectionError = rc),
        (s1.APIConnectionTimeoutError = rd),
        (s1.APIUserAbortError = ru),
        (s1.NotFoundError = rm),
        (s1.ConflictError = ry),
        (s1.RateLimitError = rg),
        (s1.BadRequestError = rh),
        (s1.AuthenticationError = rf),
        (s1.InternalServerError = r_),
        (s1.PermissionDeniedError = rp),
        (s1.UnprocessableEntityError = rb),
        (s1.toFile = rI),
        (s1.fileFromPath = h),
        (s1.Completions = nf),
        (s1.Chat = nw),
        (s1.ChatCompletionsPage = ng),
        (s1.Embeddings = nv),
        (s1.Files = nS),
        (s1.FileObjectsPage = nT),
        (s1.Images = nE),
        (s1.Audio = nP),
        (s1.Moderations = nA),
        (s1.Models = nC),
        ...
        (s1.Graders = nH),
        (s1.VectorStores = nY),
        (s1.VectorStoresPage = nG),
        (s1.VectorStoreSearchResponsesPage = nZ),
        (s1.Beta = sO),
        (s1.Batches = s$),
        (s1.BatchesPage = sj),
        (s1.Uploads = sq),
        (s1.Responses = sD),
        (s1.Evals = sX),
        (s1.EvalListResponsesPage = sK),
        (s1.Containers = sZ),
        (s1.ContainerListResponsesPage = s0);
      let s2 = s1;
    },
    60036: (e, t, r) => {
      r.d(t, { f: () => s });
      var n = r(47684);
      let s = (e) => e instanceof n.Z;
    },
    65579: (e, t, r) => {
      let n = r(28906);
      (e.exports = n),
        (e.exports.HttpAgent = n),
        (e.exports.HttpsAgent = r(12504)),
        (e.exports.constants = r(31102));
    },
    69298: (e, t) => {
      ...
      (i.prototype = {
        ...
        "undefined" != typeof window &&
          void 0 !== window.Event &&
          (Object.setPrototypeOf(i.prototype, window.Event.prototype),
          n.set(window.Event.prototype, i));
      let u = new WeakMap();
      function c(e) {
      ...
      function p() {
        if (this instanceof p) return void u.set(this, new Map());
      ...
      (p.prototype = {
        addEventListener(e, t, r) {
          ...
          let n = d(this),
            ...
            a = n.get(e);
          if (void 0 === a) return void n.set(e, i);
          let l = null;
          for (; null != a; ) {
            if (a.listener === t && a.listenerType === o) return;
            (l = a), (a = a.next);
          }
          l.next = i;
        },
        removeEventListener(e, t, r) {
          if (null == t) return;
          let n = d(this),
            s = (c(r) ? r.capture : r) ? 1 : 2,
            o = null,
            i = n.get(e);
          for (; null != i; ) {
            if (i.listener === t && i.listenerType === s)
              return void (null !== o
                ? (o.next = i.next)
                : null !== i.next
                  ? n.set(e, i.next)
        ...
        dispatchEvent(e) {
          ...
          let t = d(this),
            ...
            o = t.get(r);
          if (null == o) return !0;
          let u = new ((function e(t) {
              if (null == t || t === Object.prototype) return i;
              let r = n.get(t);
              return (
                null == r &&
                  ((r = (function (e, t) {
          ...
          for (; null != o; ) {
            if (
              (o.once
                ? null !== c
                  ...
                  : null !== o.next
                    ...
                    : t.delete(r)
                : (c = o),
              l(u, o.passive ? o.listener : null),
              "function" == typeof o.listener)
            )
              try {
                o.listener.call(this, u);
              } catch (e) {
                "undefined" != typeof console &&
                  "function" == typeof console.error &&
                  console.error(e);
              ...
              3 !== o.listenerType &&
                ...
                o.listener.handleEvent(u);
            if (s(u).immediateStopped) break;
            o = o.next;
          }
          return (
            l(u, null),
            (s(u).eventPhase = 0),
            (s(u).currentTarget = null),
            !u.defaultPrevented
          );
        },
      }),
        ...
        "undefined" != typeof window &&
          ...
          Object.setPrototypeOf(p.prototype, window.EventTarget.prototype),
        (t.defineEventAttribute = h),
        (t.EventTarget = p),
        (t.default = p),
        (e.exports = p),
        (e.exports.EventTarget = e.exports.default = p),
        (e.exports.defineEventAttribute = h);
    },
    86514: (e, t, r) => {
      r.d(t, { T: () => n });
    ...
    89732: (e, t, r) => {
      Object.defineProperty(t, "__esModule", { value: !0 });
      var n = r(69298);
      class AbortSignal extends n.EventTarget {
        constructor() {
          throw (
      ...
      n.defineEventAttribute(AbortSignal.prototype, "abort");
      let s = new WeakMap();
        ...
        constructor() {
          i.set(
            ...
            (function () {
              ...
              return n.EventTarget.call(e), s.set(e, !1), e;
            })(),
          );
        }
        get signal() {
      ...
      Object.defineProperties(o.prototype, {
        ...
        (t.default = o),
        (e.exports = o),
        (e.exports.AbortController = e.exports.default = o),
        (e.exports.AbortSignal = AbortSignal);
    },
  });
//# sourceMappingURL=7826.js.map
