...
import { Loader2, AlertCircle, Link, ExternalLink } from "lucide-react";
...
export function WebScraper() {
    ...
    const handleSingleScrape = async () => {
        ...
        try {
            const { data, error } = await scraping.scrapeUrl(url, selector, saveToStorage);
    ...
    const handleBulkScrape = async () => {
        ...
        try {
            const { data, error } = await scraping.bulkScrape(urls, selector, saveToStorage);
                    ...
                    <TabsContent value="single" className="space-y-4 mt-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Target a specific element on the page. Leave empty to extract all content.
                            </p>
                        </div>
...
export function ScrapingHistory() {
    ...
    if (history.length === 0) {
        return (
            <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertTitle>No scraping history</AlertTitle>
                <AlertDescription>
