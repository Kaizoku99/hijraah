try {
  ...
  i &&
    ...
    (a._sentryDebugIds[i] = "b2d773e7-7cd9-4264-ac6e-f542ee38ffe9"),
    (a._sentryDebugIdIdentifier =
      "sentry-dbid-b2d773e7-7cd9-4264-ac6e-f542ee38ffe9"));
} catch (a) {}
(exports.id = 7111),
  (exports.ids = [7111]),
  (exports.modules = {
    ...
    35926: (a, i, t) => {
      ...
      function v(a) {
        if ("function" != typeof a.webkitGetAsEntry) return u(a);
        let i = a.webkitGetAsEntry();
        return i && i.isDirectory ? f(i) : u(a, i);
      }
      function u(a, i) {
      ...
      var Z = (0, n.forwardRef)(function (a, i) {
        var t = a.children,
          p = X(Y(a, L)),
          e = p.open,
          o = Y(p, H);
      ...
      function X() {
        ...
        (0, n.useEffect)(
          ...
          (0, n.useEffect)(
            function () {
              return (
                !p && j && an.current && an.current.focus(), function () {}
              );
            },
            [an, j, p],
          );
        var au = (0, n.useCallback)(
            function (a) {
            ...
            function () {
              if (as.current) {
                ac({ type: "openDialog" }),
                  X(),
                  window
                    .showOpenFilePicker({ multiple: l, types: Z })
                    .then(function (a) {
                      return e(a);
                    })
                    .then(function (a) {
          ...
          aq = (0, n.useMemo)(
            ...
            [an, aw, ak, aj, az, ax, af, ag, ah, O, E, p],
          ),
      ...
      function aa(a, i) {
        switch (i.type) {
          ...
          case "openDialog":
            return G(G({}, Q), {}, { isFileDialogActive: !0 });
          case "closeDialog":
    ...
    67155: (a, i, t) => {
      ...
      var n = t(84205);
      function p(a) {
        let i = n.useRef({ value: a, previous: a });
        return n.useMemo(
          () => (
            i.current.value !== a &&
