...
import type { Suggestion } from "@/supabase/schema";
import { Suggestion as PreviewSuggestion } from "@/ui/suggestion";

import type { Node } from "prosemirror-model";

// UISuggestion extends the Suggestion type from the database schema
