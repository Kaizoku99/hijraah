...
export default function DocumentChecklist() {
  ...
  const downloadChecklist = () => {
    const checklist = `${visaTypes[selectedType as keyof typeof visaTypes].name} Document Checklist\n\n` +
      visaTypes[selectedType as keyof typeof visaTypes].documents.map(doc =>
        `[${checkedItems.includes(doc) ? 'x' : ' '}] ${doc}`
      ).join('\n');
          ...
          {selectedType && (
            <>
              <div className="space-y-4">
                ...
                {visaTypes[selectedType as keyof typeof visaTypes].documents.map((document) => (
              ...
              <div className="pt-6 border-t">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <span className="text-sm">
                    {checkedItems.length} of {visaTypes[selectedType as keyof typeof visaTypes].documents.length} complete
                  </span>
                </div>
