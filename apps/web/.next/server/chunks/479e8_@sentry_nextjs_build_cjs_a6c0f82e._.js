module.exports = {
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/util.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      ...
      } = __turbopack_context__;
      {
        ...
        const resolve = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/resolve@1.22.8/node_modules/resolve/index.js [instrumentation-edge] (ecmascript)",
        );
        /**
          ...
          if (nextjsPackageJsonPath) {
            try {
              const nextjsPackageJson = JSON.parse(
                fs.readFileSync(nextjsPackageJsonPath, {
                  encoding: "utf-8",
                }),
              );
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
         ...
         */ function getWebpackPluginOptions(
          ...
          if (isServer) {
            sourcemapUploadAssets.push(
              path.posix.join(distDirAbsPath, "server", "**"),
              path.posix.join(distDirAbsPath, "serverless", "**"),
            );
          } else {
            if (sentryBuildOptions.widenClientFileUpload) {
              sourcemapUploadAssets.push(
                path.posix.join(distDirAbsPath, "static", "chunks", "**"),
              );
            } else {
              sourcemapUploadAssets.push(
                path.posix.join(
          ...
          return {
            ...
            sourcemaps: {
              ...
              assets:
                sentryBuildOptions.sourcemaps?.assets ?? sourcemapUploadAssets,
              ignore:
                sentryBuildOptions.sourcemaps?.ignore ?? sourcemapUploadIgnore,
              filesToDeleteAfterUpload: sentryBuildOptions.sourcemaps
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const chalk = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/chalk@3.0.0/node_modules/chalk/source/index.js [instrumentation-edge] (ecmascript)",
        );
        const fs = __turbopack_context__.r(
          "[externals]/fs [external] (fs, cjs)",
        );
        ...
        const webpackPluginOptions = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation-edge] (ecmascript)",
        );
         ...
         */ function constructWebpackConfigFunction(
          ...
          return function newWebpackFunction(incomingConfig, buildContext) {
            ...
            const dotPrefixedPageExtensions = pageExtensions.map(
              (ext) => `.${ext}`,
            );
            const pageExtensionRegex = pageExtensions
              .map(core.escapeStringForRegex)
              .join("|");
            ...
            const instrumentationFile = getInstrumentationFile(
              projectDir,
              dotPrefixedPageExtensions.concat([".ts", ".js"]),
            );
            if (runtime !== "client") {
              warnAboutDeprecatedConfigFiles(
                projectDir,
                instrumentationFile,
                runtime,
              );
            ...
            const apiRoutesPath = pagesDirPath
              ? path.join(pagesDirPath, "api")
              : undefined;
            ...
            const staticWrappingLoaderOptions = {
              ...
              nextjsRequestAsyncStorageModulePath:
                getRequestAsyncStorageModuleLocation(
                  projectDir,
            ...
            const isPageResource = (resourcePath) => {
              const normalizedAbsoluteResourcePath =
                normalizeLoaderResourcePath(resourcePath);
              return (
                pagesDirPath !== undefined &&
                normalizedAbsoluteResourcePath.startsWith(
                  pagesDirPath + path.sep,
                ) &&
                !normalizedAbsoluteResourcePath.startsWith(
                  apiRoutesPath + path.sep,
                ) &&
                dotPrefixedPageExtensions.some((ext) =>
                  normalizedAbsoluteResourcePath.endsWith(ext),
                )
              );
            };
            ...
            const possibleMiddlewareLocations = pageExtensions.map(
              (middlewareFileEnding) => {
                return path.join(
                  middlewareLocationFolder,
                  `middleware.${middlewareFileEnding}`,
                );
              },
            );
            const isMiddlewareResource = (resourcePath) => {
              const normalizedAbsoluteResourcePath =
                normalizeLoaderResourcePath(resourcePath);
              return possibleMiddlewareLocations.includes(
                normalizedAbsoluteResourcePath,
              );
            };
            const isServerComponentResource = (resourcePath) => {
              ...
              return (
                ...
                !!normalizedAbsoluteResourcePath.match(
                  ...
                  new RegExp(
                    `[\\\\/](page|layout|loading|head|not-found)\\.(${pageExtensionRegex})$`,
                  ),
                )
              );
            };
            ...
            if (
              isServer &&
              userSentryOptions.autoInstrumentServerFunctions !== false
            ) {
              ...
              try {
                if (
                  ...
                  if (vercelCronsConfig) {
                    core.logger.info(
                      `${chalk.cyan("info")} - Creating Sentry cron monitors for your Vercel Cron Jobs. You can disable this feature by setting the ${chalk.bold.cyan("automaticVercelMonitors")} option to false in you Next.js config.`,
                    );
                  }
                }
              } catch (e) {
                if (e.code === "ENOENT");
                  ...
                  // log but noop
                  core.logger.error(
                    `${chalk.red("error")} - Sentry failed to read vercel.json for automatic cron job monitoring instrumentation`,
                    e,
                  );
                }
              }
            ...
            if (
              isServer &&
              userSentryOptions.autoInstrumentAppDirectory !== false
            ) {
            ...
            if (appDirPath) {
              const hasGlobalErrorFile = pageExtensions
                ...
                .some(
                  ...
                  (globalErrorFile) =>
                    fs.existsSync(path.join(appDirPath, globalErrorFile)),
                );
              if (
                !hasGlobalErrorFile &&
            ...
            if (!isServer) {
              ...
              newConfig.entry = async () =>
                addSentryToClientEntryProperty(origEntryProperty, buildContext);
              const clientSentryConfigFileName =
                getClientSentryConfigFile(projectDir);
            ...
            if (!(isDev || (isStaticExport && isServer))) {
              ...
              const { sentryWebpackPlugin } =
                core.loadModule("@sentry/webpack-plugin", module) ?? {};
              if (sentryWebpackPlugin) {
                if (!userSentryOptions.sourcemaps?.disable) {
                  ...
                  if (!newConfig.devtool) {
                    core.logger.info(
                      `[@sentry/nextjs] Automatically enabling source map generation for ${runtime} build.`,
                    );
                  ...
                  if (
                    ...
                    userSentryOptions.sourcemaps
                      ?.deleteSourcemapsAfterUpload === undefined
                  ) {
                    core.logger.warn(
                ...
                const sentryWebpackPluginInstance = sentryWebpackPlugin(
                  webpackPluginOptions.getWebpackPluginOptions(
                    buildContext,
                    userSentryOptions,
                    releaseName,
                  ),
         ...
         */ async function addSentryToClientEntryProperty(
          ...
          const instrumentationClientFileName =
            getInstrumentationClientFile(projectDir);
          const filesToInject = [];
          if (clientSentryConfigFileName) {
          ...
          for (const entryPointName in newEntryProperty) {
            if (
              entryPointName === "pages/_app" || // entrypoint for `/app` pages
          ...
          for (const pathSegments of paths) {
            try {
              return fs.readFileSync(
                path.resolve(projectDir, ...pathSegments),
                {
                  encoding: "utf-8",
                },
              );
         ...
         */ function warnAboutMissingOnRequestErrorHandler(
          instrumentationFile,
        ) {
         ...
         */ function warnAboutDeprecatedConfigFiles(
          ...
          const hasInstrumentationHookWithIndicationsOfSentry =
            ...
            (instrumentationFile.includes("@sentry/") ||
              instrumentationFile.match(
                /sentry\.(server|edge)\.config(\.(ts|js))?/,
              ));
         ...
         */ function addFilesToWebpackEntryPoint(
          ...
          if (
            ...
            newEntryPoint = Array.isArray(currentEntryPoint)
              ? currentEntryPoint
              : [currentEntryPoint];
            ...
            const newImportValue = Array.isArray(currentImportValue)
              ? currentImportValue
              : [currentImportValue];
        ...
        function addValueInjectionLoader(
          ...
          const assetPrefix =
            userNextConfig.assetPrefix || userNextConfig.basePath || "";
          const isomorphicValues = {
            ...
            SENTRY_RELEASE:
              releaseName && !buildContext.dev
                ? {
                    id: releaseName,
                  }
                : undefined,
            _sentryBasePath: buildContext.dev
              ? userNextConfig.basePath
              : undefined,
          };
          const serverValues = {
            ...isomorphicValues,
          ...
          const clientValues = {
            ...
            _sentryExperimentalThirdPartyOriginStackFrames: userSentryOptions
              ._experimental?.thirdPartyOriginStackFrames
              ? "true"
              : undefined,
          };
        ...
        function resolveNextPackageDirFromDirectory(basedir) {
          try {
            return path.dirname(
              resolve.sync("next/package.json", {
                basedir,
              }),
            );
          } catch {
        ...
        function getRequestAsyncStorageModuleLocation(
          ...
          const absoluteWebpackResolvableModuleLocations =
            webpackResolvableModuleLocations.map((loc) =>
              path.resolve(webpackContextDir, loc),
            );
          for (const webpackResolvableLocation of absoluteWebpackResolvableModuleLocations) {
            const nextPackageDir = resolveNextPackageDirFromDirectory(
              webpackResolvableLocation,
            );
            if (nextPackageDir) {
              const asyncLocalStorageLocation =
                POTENTIAL_REQUEST_ASYNC_STORAGE_LOCATIONS.find((loc) =>
          ...
          const ignoreRules = [
            ...
            (warning, compilation) => {
              ...
              try {
                ...
                return (
                  isDependencyThatMayRaiseCriticalDependencyMessage &&
                  isCriticalDependencyMessage
                );
              } catch {
                return false;
              }
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const webpack = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation-edge] (ecmascript)",
        );
          ...
          if (typeof castNextConfig === "function") {
            return function (...webpackConfigFunctionArgs) {
              ...
              if (core.isThenable(maybePromiseNextConfig)) {
                return maybePromiseNextConfig.then(
                  (promiseResultNextConfig) => {
                    return getFinalConfigObject(
                      promiseResultNextConfig,
                      sentryBuildOptions,
                    );
                  },
        ...
        function getFinalConfigObject(
          ...
          if (nextJsVersion) {
            ...
            const isFullySupportedRelease =
              ...
              patch !== undefined &&
              major >= 15 &&
              ((minor === 0 && patch === 0 && prerelease === undefined) ||
                minor > 0 ||
                patch > 0);
          ...
          const instrumentationClientFileContents =
            getInstrumentationClientFileContents();
          if (
            instrumentationClientFileContents !== undefined &&
            !instrumentationClientFileContents.includes(
          ...
          if (nextJsVersion) {
            ...
            const supportsClientInstrumentation =
              isSupportedCanary || isSupportedVersion;
            if (
        ...
        function setUpBuildTimeVariables(
          ...
          if (userSentryOptions._experimental?.thirdPartyOriginStackFrames) {
            buildTimeVariables._experimentalThirdPartyOriginStackFrames =
              "true";
          }
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const stackTraceParser = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/stacktrace-parser@0.1.11/node_modules/stacktrace-parser/dist/stack-trace-parser.esm.js [instrumentation-edge] (ecmascript)",
        );
         ...
         */ async function devErrorSymbolicationEventProcessor(event, hint) {
          ...
          if (event.type === "transaction") {
            event.spans = event.spans?.filter((span) => {
              ...
              if (typeof httpUrlAttribute === "string") {
                return !httpUrlAttribute.includes(
                  "__nextjs_original-stack-frame",
                ); // could also be __nextjs_original-stack-frames (plural)
              }
              return true;
            });
          }
          ...
          try {
            if (
              ...
              const frames = stackTraceParser.parse(
                hint.originalException.stack,
              );
              const nextjsVersion =
                globalWithInjectedValues.next?.version || "0.0.0";
              const parsedNextjsVersion = ("TURBOPACK compile-time truthy", 1)
                ? core.parseSemver(nextjsVersion)
                : ("TURBOPACK unreachable", undefined);
              let resolvedFrames;
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
              if (
                parsedNextjsVersion.major > 15 ||
                (parsedNextjsVersion.major === 15 &&
                  parsedNextjsVersion.minor >= 2)
              ) {
                ...
                resolvedFrames = await Promise.all(
                  frames.map((frame) =>
                    resolveStackFrame(frame, hint.originalException),
                  ),
                );
              }
              if (event.exception?.values?.[0]?.stacktrace?.frames) {
                event.exception.values[0].stacktrace.frames =
                  event.exception.values[0].stacktrace.frames.map(
                    (frame, i, frames) => {
                      const resolvedFrame =
                        resolvedFrames[frames.length - 1 - i];
                      if (
                      ...
                      return {
                        ...
                        filename:
                          resolvedFrame.originalStackFrame.file || undefined,
                        lineno:
                          resolvedFrame.originalStackFrame.lineNumber ||
                          undefined,
                        colno:
                          resolvedFrame.originalStackFrame.column || undefined,
                      };
                    },
                  );
              }
        ...
        async function resolveStackFrame(frame, error) {
          try {
            ...
            let basePath =
              process.env._sentryBasePath ??
              globalWithInjectedValues._sentryBasePath ??
              "";
              ...
              fetch(
                `${
                  ...
                  ("TURBOPACK compile-time truthy", 1)
                    ? "http://localhost:3000"
                    : ("TURBOPACK unreachable", undefined) // TODO: handle the case where users define a different port
        ...
        exports.devErrorSymbolicationEventProcessor =
          devErrorSymbolicationEventProcessor; //# sourceMappingURL=devErrorSymbolicationEventProcessor.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ const TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION =
          "sentry.drop_transaction";
        const TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL =
          "sentry.sentry_trace_backfill";
        const TRANSACTION_ATTR_SENTRY_ROUTE_BACKFILL = "sentry.route_backfill";
        exports.TRANSACTION_ATTR_SENTRY_ROUTE_BACKFILL =
          TRANSACTION_ATTR_SENTRY_ROUTE_BACKFILL;
        exports.TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL =
          TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL;
        exports.TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION =
          TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION; //# sourceMappingURL=span-attributes-with-logic-attached.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const constants = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/next@15.3.0-canary.31_@babe_be67f368de2727c847f3a61f5e6cf4fa/node_modules/next/constants.js [instrumentation-edge] (ecmascript)",
        );
        /**
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const distDirRewriteFramesIntegration = core.defineIntegration(
          ({ distDirName }) => {
            ...
            const distDirAbsPath = path
              .resolve(distDirName)
              .replace(/(\/|\\)$/, ""); // We strip trailing slashes because "app:///_next" also doesn't have one
            // eslint-disable-next-line @sentry-internal/sdk/no-regexp-constructor -- user input is escaped
            const SOURCEMAP_FILENAME_REGEX = new RegExp(
              core.escapeStringForRegex(distDirAbsPath),
            );
        ...
        exports.distDirRewriteFramesIntegration =
          distDirRewriteFramesIntegration; //# sourceMappingURL=distDirRewriteFramesIntegration.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ async function flushSafelyWithTimeout() {
          try {
            ...
            debugBuild.DEBUG_BUILD &&
              core.logger.log("Error while flushing events:\n", e);
          }
        }
        exports.flushSafelyWithTimeout = flushSafelyWithTimeout; //# sourceMappingURL=responseEnd.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const responseEnd = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation-edge] (ecmascript)",
        );
        /**
         ...
         */ async function captureUnderscoreErrorException(contextOrProps) {
          ...
          core.withScope((scope) => {
            ...
            core.captureException(
              err || `_error.js called with falsy error (${err})`,
              {
                mechanism: {
                  type: "instrument",
                  handled: false,
        ...
        exports.captureUnderscoreErrorException =
          captureUnderscoreErrorException; //# sourceMappingURL=_error.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const spanAttributesWithLogicAttached = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)",
        );
        /**
        ...
        function withTracedServerSideDataFetcher(
          ...
          return async function (...args) {
            ...
            core
              .getCurrentScope()
              .setTransactionName(
                `${options.dataFetchingMethodName} (${options.dataFetcherRouteName})`,
              );
            ...
            if (span && options.requestedRouteName !== "/_error") {
              ...
              root.setAttribute(
                spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_ROUTE_BACKFILL,
                options.requestedRouteName,
              );
            }
            const { "sentry-trace": sentryTrace, baggage } =
              core.getTraceData();
            return {
        ...
        exports.withTracedServerSideDataFetcher =
          withTracedServerSideDataFetcher; //# sourceMappingURL=wrapperUtils.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const isBuild = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)",
        );
        const wrapperUtils = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation-edge] (ecmascript)",
        );
        /**
         ...
         */ function wrapGetStaticPropsWithSentry(
          ...
          return new Proxy(origGetStaticPropsa, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              const errorWrappedGetStaticProps =
                wrapperUtils.withErrorInstrumentation(wrappingTarget);
              return wrapperUtils.callDataFetcherTraced(
                errorWrappedGetStaticProps,
                args,
              );
            },
          });
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
         ...
         */ function wrapGetInitialPropsWithSentry(origGetInitialProps) {
          return new Proxy(origGetInitialProps, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              if (req && res) {
                const tracedGetInitialProps =
                  wrapperUtils.withTracedServerSideDataFetcher(
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ function wrapAppGetInitialPropsWithSentry(origAppGetInitialProps) {
          return new Proxy(origAppGetInitialProps, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              const errorWrappedAppGetInitialProps =
                wrapperUtils.withErrorInstrumentation(wrappingTarget);
              // Generally we can assume that `req` and `res` are always defined on the server:
              // https://nextjs.org/docs/api-reference/data-fetching/get-initial-props#context-object
              // This does not seem to be the case in dev mode. Because we have no clean way of associating the the data fetcher
              ...
              if (req && res) {
                ...
                if (
                  typeof appGetInitialProps === "object" &&
                  appGetInitialProps !== null
                ) {
        ...
        exports.wrapAppGetInitialPropsWithSentry =
          wrapAppGetInitialPropsWithSentry; //# sourceMappingURL=wrapAppGetInitialPropsWithSentry.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
          ...
          return new Proxy(origDocumentGetInitialProps, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              if (req && res) {
                ...
                const { data } = await tracedGetInitialProps.apply(
                  thisArg,
                  args,
                );
                return data;
        ...
        exports.wrapDocumentGetInitialPropsWithSentry =
          wrapDocumentGetInitialPropsWithSentry; //# sourceMappingURL=wrapDocumentGetInitialPropsWithSentry.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
          ...
          return new Proxy(origErrorGetInitialProps, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              if (req && res) {
                ...
                if (
                  typeof errorGetInitialProps === "object" &&
                  errorGetInitialProps !== null
                ) {
                  if (sentryTrace) {
                    // The Next.js serializer throws on undefined values so we need to guard for it (#12102)
        ...
        exports.wrapErrorGetInitialPropsWithSentry =
          wrapErrorGetInitialPropsWithSentry; //# sourceMappingURL=wrapErrorGetInitialPropsWithSentry.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
          ...
          return new Proxy(origGetServerSideProps, {
            apply: async (wrappingTarget, thisArg, args) => {
              ...
              const errorWrappedGetServerSideProps =
                wrapperUtils.withErrorInstrumentation(wrappingTarget);
              const tracedGetServerSideProps =
                wrapperUtils.withTracedServerSideDataFetcher(
        ...
        exports.wrapGetServerSidePropsWithSentry =
          wrapGetServerSidePropsWithSentry; //# sourceMappingURL=wrapGetServerSidePropsWithSentry.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ function commonObjectToPropagationContext(
          ...
          if (typeof commonObject === "object" && commonObject) {
            const memoPropagationContext =
              commonPropagationContextMap.get(commonObject);
         ...
         */ function commonObjectToIsolationScope(commonObject) {
          if (typeof commonObject === "object" && commonObject) {
            const memoIsolationScope =
              commonIsolationScopeMap.get(commonObject);
         ...
         */ function escapeNextjsTracing(cb) {
          const MaybeGlobalAsyncLocalStorage =
            core.GLOBAL_OBJ.AsyncLocalStorage;
         ...
         */ function dropNextjsRootContext() {
          ...
          if (nextJsOwnedSpan) {
            ...
            if (rootSpanAttributes?.["next.span_type"]) {
              core
                .getRootSpan(nextJsOwnedSpan)
                ?.setAttribute(
                  spanAttributesWithLogicAttached.TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION,
                  true,
                );
            }
          }
        ...
        exports.commonObjectToPropagationContext =
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ function buildUrlFromComponentRoute(
          ...
          const parameterizedPath = substituteRouteParams(
            componentRoute,
            params,
          );
          ...
          const host =
            headersDict?.[HeaderKeys.FORWARDED_HOST] ||
            headersDict?.[HeaderKeys.HOST];
          if (!protocol || !host) {
            return path;
          }
         ...
         */ function getSanitizedRequestUrl(
          ...
          return buildUrlFromComponentRoute(
            componentRoute,
            params,
            headersDict,
            pathname,
        ...
        exports.extractSanitizedUrlFromRefererHeader =
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const nextNavigationErrorUtils = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation-edge] (ecmascript)",
        );
        const spanAttributesWithLogicAttached = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)",
        ...
        const tracingUtils = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation-edge] (ecmascript)",
        );
        const urls = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/utils/urls.js [instrumentation-edge] (ecmascript)",
        );
        /**
        ...
        function wrapServerComponentWithSentry(appDirComponent, context) {
          ...
          return new Proxy(appDirComponent, {
            apply: (originalFunction, thisArg, args) => {
              const requestTraceId = core
                .getActiveSpan()
                ?.spanContext().traceId;
              const isolationScope = tracingUtils.commonObjectToIsolationScope(
                context.headers,
              );
              ...
              const headersDict = context.headers
                ? core.winterCGHeadersToDict(context.headers)
                : undefined;
              ...
              return core.withIsolationScope(isolationScope, () => {
                return core.withScope((scope) => {
                  scope.setTransactionName(
                    `${componentType} Server Component (${componentRoute})`,
                  );
                  ...
                  if (activeSpan) {
                    ...
                    if (sentryTrace) {
                      rootSpan.setAttribute(
                        spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL,
                        sentryTrace,
                      );
                    }
                  }
                    ...
                    (span) => {
                      return core.handleCallbackErrors(
                        ...
                        (error) => {
                          ...
                          if (
                            nextNavigationErrorUtils.isNotFoundNavigationError(
                              error,
                            )
                          ) {
                            ...
                            nextNavigationErrorUtils.isRedirectNavigationError(
                              error,
                            )
                          ) {
                        ...
                        () => {
                          ...
                          core.vercelWaitUntil(
                            responseEnd.flushSafelyWithTimeout(),
                          );
                        },
                      );
                    },
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        function wrapApiHandlerWithSentryVercelCrons(
          ...
          return new Proxy(handler, {
            ...
            apply: (originalFunction, thisArg, args) => {
              ...
              const cronsKey =
                "nextUrl" in req ? req.nextUrl.pathname : req.url;
              ...
              const vercelCron = vercelCronsConfig.find(
                (vercelCron) => vercelCron.path === cronsKey,
              );
        ...
        exports.wrapApiHandlerWithSentryVercelCrons =
          wrapApiHandlerWithSentryVercelCrons; //# sourceMappingURL=wrapApiHandlerWithSentryVercelCrons.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        function isReactClassComponent(target) {
          // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
          return (
            typeof target === "function" && target?.prototype?.isReactComponent
          );
        }
        /**
                ...
                return core.withIsolationScope(() => {
                  ...
                  if (sentryTraceData) {
                    const traceparentData =
                      core.extractTraceparentData(sentryTraceData);
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
          ...
          return new Proxy(generationFunction, {
            apply: (originalFunction, thisArg, args) => {
              ...
              const isolationScope =
                tracingUtils.commonObjectToIsolationScope(headers);
              let pathname = undefined;
              const activeSpan = core.getActiveSpan();
              if (activeSpan) {
                const rootSpan = core.getRootSpan(activeSpan);
              ...
              return core.withIsolationScope(isolationScope, () => {
                return core.withScope((scope) => {
                  scope.setTransactionName(
                    `${componentType}.${generationFunctionIdentifier} (${componentRoute})`,
                  );
                  isolationScope.setSDKProcessingMetadata({
                    normalizedRequest: {
                      headers: headersDict,
                  ...
                  const propagationContext =
                    tracingUtils.commonObjectToPropagationContext(
                      headers,
                      core.propagationContextFromHeaders(
        ...
        exports.wrapGenerationFunctionWithSentry =
          wrapGenerationFunctionWithSentry; //# sourceMappingURL=wrapGenerationFunctionWithSentry.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
         ...
         */ function withServerActionInstrumentation(...args) {
          if (typeof args[1] === "function") {
            ...
            return withServerActionInstrumentationImplementation(
              serverActionName,
              {},
              callback,
            );
        ...
        async function withServerActionInstrumentationImplementation(
          ...
          return core.withIsolationScope(async (isolationScope) => {
            ...
            try {
              ...
              sentryTraceHeader =
                awaitedHeaders?.get("sentry-trace") ?? undefined;
              ...
              async () => {
                try {
                  return await core.startSpan(
                    ...
                    async (span) => {
                      const result = await core.handleCallbackErrors(
                        callback,
                        (error) => {
                          if (
                            nextNavigationErrorUtils.isNotFoundNavigationError(
                      ...
                      if (
                        options.recordResponse !== undefined
                          ? options.recordResponse
                          : sendDefaultPii
                      ) {
                        core
                          .getIsolationScope()
                          .setExtra("server_action_result", result);
                      }
                      if (options.formData) {
        ...
        exports.withServerActionInstrumentation =
          withServerActionInstrumentation; //# sourceMappingURL=withServerActionInstrumentation.js.map
      }
    },
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
                  ...
                  return continueTraceIfNoActiveSpan(
                    {
                      sentryTrace:
                        req.headers &&
                        core.isString(req.headers["sentry-trace"])
                    ...
                    () => {
                      ...
                      const normalizedRequest =
                        core.httpRequestToRequestData(req);
                      isolationScope.setSDKProcessingMetadata({
                        normalizedRequest,
                      });
                      isolationScope.setTransactionName(
                        `${reqMethod}${parameterizedRoute}`,
                      );
                      return core.startSpanManual(
                        {
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const devErrorSymbolicationEventProcessor = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation-edge] (ecmascript)",
        );
        const getVercelEnv = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation-edge] (ecmascript)",
        );
        const spanAttributesWithLogicAttached = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)",
        ...
        const distDirRewriteFramesIntegration = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation-edge] (ecmascript)",
        );
        const _error = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation-edge] (ecmascript)",
        );
        const wrapGetStaticPropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapGetInitialPropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapAppGetInitialPropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapDocumentGetInitialPropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapErrorGetInitialPropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapGetServerSidePropsWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapServerComponentWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapRouteHandlerWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapApiHandlerWithSentryVercelCrons = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation-edge] (ecmascript)",
        );
        const wrapMiddlewareWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapPageComponentWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const wrapGenerationFunctionWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const withServerActionInstrumentation = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation-edge] (ecmascript)",
        );
        const captureRequestError = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation-edge] (ecmascript)",
        );
        const wrapApiHandlerWithSentry = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation-edge] (ecmascript)",
        );
        const globalWithInjectedValues = core.GLOBAL_OBJ;
        /**
        ...
        /** Inits the Sentry NextJS SDK on node. */ function init(options) {
          ...
          const customDefaultIntegrations = node
          ...
          const distDirName =
            ("TURBOPACK compile-time value", ".next") ||
            globalWithInjectedValues._sentryRewriteFramesDistDir;
          if (("TURBOPACK compile-time truthy", 1)) {
          ...
          const opts = {
            environment:
              ...
              getVercelEnv.getVercelEnv(false) ||
              ("TURBOPACK compile-time value", "development"),
            release:
              ("TURBOPACK compile-time value",
              "d92a5e8d8d7c20e1f785b33fde2c15257fdb31d2") ||
              globalWithInjectedValues._sentryRelease,
          ...
          if (sdkAlreadyInitialized()) {
            debugBuild.DEBUG_BUILD &&
              core.logger.log("SDK already initialized");
            return;
          }
          ...
          client?.on(
            "beforeSampling",
            ({ spanAttributes }, samplingDecision) => {
              ...
              if (
                ...
                (typeof spanAttributes[
                  semanticConventions.SEMATTRS_HTTP_TARGET
                ] === "string" && // eslint-disable-next-line deprecation/deprecation
                  spanAttributes[
                    semanticConventions.SEMATTRS_HTTP_TARGET
                  ].includes("sentry_key") && // eslint-disable-next-line deprecation/deprecation
                  spanAttributes[
                    semanticConventions.SEMATTRS_HTTP_TARGET
                  ].includes("sentry_client")) ||
                (typeof spanAttributes[semanticConventions.ATTR_URL_QUERY] ===
                  "string" &&
                  spanAttributes[semanticConventions.ATTR_URL_QUERY].includes(
                    "sentry_key",
                  ) &&
                  spanAttributes[semanticConventions.ATTR_URL_QUERY].includes(
                    "sentry_client",
          ...
          client?.on("spanStart", (span) => {
            ...
            if (typeof spanAttributes?.["next.route"] === "string") {
              ...
              if (
                ...
                const route = spanAttributes["next.route"].replace(
                  /\/route$/,
                  "",
                );
            ...
            if (
              spanAttributes?.["next.span_type"] ===
                "BaseServer.handleRequest" &&
              span === core.getRootSpan(span)
            ) {
              const scopes = core.getCapturedScopesOnSpan(span);
              const isolationScope = (
                scopes.isolationScope || core.getIsolationScope()
              ).clone();
              const scope = scopes.scope || core.getCurrentScope();
              const currentScopesPointer = opentelemetry.getScopesFromContext(
                api.context.active(),
              );
            ...
            Object.assign(
              (event) => {
                if (event.type === "transaction") {
                  ...
                  if (
                    event.transaction?.match(/^GET (\/.*)?\/_next\/static\//)
                  ) {
                    return null;
                  }
                  ...
                  if (
                    (globalWithInjectedValues._sentryRewritesTunnelPath &&
                      event.transaction ===
                        `POST ${globalWithInjectedValues._sentryRewritesTunnelPath}`) ||
                    (("TURBOPACK compile-time value", "/monitoring") &&
                      event.transaction ===
                        `POST ${("TURBOPACK compile-time value", "/monitoring")}`)
                  ) {
                    return null;
                  }
                  // Filter out requests to resolve source maps for stack frames in dev mode
                  if (
                    event.transaction?.match(/\/__nextjs_original-stack-frame/)
                  ) {
                    return null;
                  }
                  ...
                  if (
                    event.contexts?.trace?.data?.[
                      spanAttributesWithLogicAttached
                  ...
                  if (
                    typeof event.contexts?.trace?.data?.[
                      spanAttributesWithLogicAttached
                        .TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL
                    ] === "string"
                  ) {
            ...
            Object.assign(
              (event, hint) => {
                ...
                if (
                  ...
                  exceptionMessage?.includes(
                    "Suspense Exception: This is not a real error, and should not leak",
                  )
                ) {
                  return null;
                }
          ...
          client?.on("preprocessEvent", (event) => {
            ...
            if (
              ...
              event.contexts.trace.data[core.SEMANTIC_ATTRIBUTE_SENTRY_OP] =
                "http.server";
              event.contexts.trace.op = "http.server";
              if (event.transaction) {
                event.transaction = core.stripUrlQueryAndFragment(
                  event.transaction,
                );
              }
              // eslint-disable-next-line deprecation/deprecation
              ...
              const route =
                event.contexts.trace.data[
                  semanticConventions.ATTR_HTTP_ROUTE
                ] || event.contexts.trace.data["next.route"];
            ...
            if (
              ...
              if (traceparentData?.parentSpanId) {
                event.contexts.trace.parent_span_id =
                  traceparentData.parentSpanId;
              }
            }
          });
          if (("TURBOPACK compile-time truthy", 1)) {
          ...
          debugBuild.DEBUG_BUILD &&
            core.logger.log("SDK successfully initialized");
          return client;
        }
        ...
        exports.wrapServerComponentWithSentry =
          wrapServerComponentWithSentry.wrapServerComponentWithSentry;
        exports.wrapRouteHandlerWithSentry =
        ...
        exports.wrapMiddlewareWithSentry =
          wrapMiddlewareWithSentry.wrapMiddlewareWithSentry;
        exports.wrapPageComponentWithSentry =
        ...
        exports.wrapApiHandlerWithSentry =
  ...
  "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/index.server.js [instrumentation-edge] (ecmascript)":
    function (__turbopack_context__) {
      var {
        g: global,
        __dirname,
      ...
      } = __turbopack_context__;
      {
        ...
        const withSentryConfig = __turbopack_context__.r(
          "[project]/node_modules/.pnpm/@sentry+nextjs@9.30.0_@open_9120321d361c9aa9100da32b64ecc80e/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation-edge] (ecmascript)",
        );
...
//# sourceMappingURL=479e8_%40sentry_nextjs_build_cjs_a6c0f82e._.js.map
