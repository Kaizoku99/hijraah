...
async function main() {
  ...
  try {
    ...
    print(
      "PostgreSQL client tools are recommended for database management",
      "yellow",
    );
    print(
      "Visit https://www.postgresql.org/download/ to install them",
      "yellow",
    );
  }
  ...
  print("\nNext steps:", "green");
  print(
    '1. Run "node scripts/setup-local-supabase.js" to set up the local environment',
    "cyan",
  );
  print(
    '2. Run "npm run dev:local" to start the development server with local Supabase',
    "cyan",
  );
}
