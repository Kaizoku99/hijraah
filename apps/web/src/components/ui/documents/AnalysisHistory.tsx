...
export function AnalysisHistory({
  ...
  const compareSelectedAnalyses = () => {
    ...
    const analysis1 = history.find(
      (item) => item.id === selectedAnalysisIds[0],
    );
    const analysis2 = history.find(
      (item) => item.id === selectedAnalysisIds[1],
    );
                ...
                <TableBody>
                  {history.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant={item.is_valid ? "default" : "destructive"}
                        >
                  ...
                  <div className="flex gap-4">
                    <div className="flex-1 p-3 border rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        {Math.round(
                          comparisonResult.completenessComparison.source1Score *
                            100,
                        )}
                        %
                      </div>
                    ...
                    <div className="flex-1 p-3 border rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        {Math.round(
                          comparisonResult.completenessComparison.source2Score *
                            100,
                        )}
                        %
                      </div>
                    ...
                    <div className="flex-1 p-3 border rounded-lg">
                      ...
                      <div
                        className={`text-2xl font-bold ${comparisonResult.completenessComparison.difference > 0 ? "text-green-600" : comparisonResult.completenessComparison.difference < 0 ? "text-red-600" : ""}`}
                      >
                        {comparisonResult.completenessComparison.difference > 0
                          ? "+"
                          : ""}
                        {Math.round(
                          comparisonResult.completenessComparison.difference *
                            100,
                        )}
                        %
                      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 p-3 border rounded-lg">
                      ...
                      <div
                        className={`text-2xl font-bold ${comparisonResult.errorComparison.difference > 0 ? "text-green-600" : comparisonResult.errorComparison.difference < 0 ? "text-red-600" : ""}`}
                      >
                ...
                <div className="space-y-4">
                  ...
                  {comparisonResult.fieldDifferences.length === 0 ? (
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {comparisonResult.fieldDifferences.map(
                          (diff, index) => (
                            <TableRow key={index}>
                              ...
                              <TableCell>
                                {diff.source1Value?.toString() || "-"}
                              </TableCell>
                              <TableCell>
                                {diff.source2Value?.toString() || "-"}
                              </TableCell>
                              <TableCell>
                                {diff.isSignificant ? (
