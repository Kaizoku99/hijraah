      ...
      try {
        ...
        const processedRoadmaps = roadmapsData.map((roadmap) => {
          ...
          if (roadmap.completion_percentage === 100) {
            ...
            const hasBlocked = roadmap.phases.some(
              (phase: any) => phase.status === "blocked",
            );
            const hasOverdue = roadmap.phases.some(
              (phase: any) => phase.status === "overdue",
            );
            const hasInProgress = roadmap.phases.some(
          ...
          return {
            ...
            title:
              roadmap.title ||
              `Roadmap for ${roadmap.cases?.title || roadmap.case_id}`,
          };
        });
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-500">
              Roadmaps are created from immigration cases. Visit your cases to
              create a roadmap.
            </p>
          </CardContent>
          <CardFooter>
              ...
              <Card className="h-full hover:shadow-md transition-shadow duration-200 cursor-pointer">
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    ...
                    <div>{getStatusBadge(roadmap.status)}</div>
                  </div>
                ...
                <CardContent>
                  ...
                  <Progress
                    value={roadmap.completion_percentage}
                    className="h-2 mb-4"
                  />
