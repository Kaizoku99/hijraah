...
export const AgentExecutionContextSchema = z.object({
  ...
  timeout: z.number(),
  metadata: z.record(z.string(), z.any()).optional(),
  sharedContext: z.record(z.string(), z.any()).optional(), // Shared between workflow steps
});
...
export type ScheduledAgentExecution = z.infer<
  typeof ScheduledAgentExecutionSchema
>;
