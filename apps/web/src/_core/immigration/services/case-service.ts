...
export class CaseService {
  ...
  isValidStatusTransition(
    ...
    const validTransitions: Record<CaseStatus, CaseStatus[]> = {
      ...
      [CaseStatus.SUBMITTED]: [CaseStatus.IN_REVIEW, CaseStatus.CANCELLED],
      ...
      [CaseStatus.APPROVED]: [CaseStatus.COMPLETED, CaseStatus.CANCELLED],
      [CaseStatus.REJECTED]: [
  ...
  estimateProcessingTime(caseType: CaseType): {
    ...
    const processingTimeEstimates: Record<
      CaseType,
      {
        minDays: number;
        maxDays: number;
