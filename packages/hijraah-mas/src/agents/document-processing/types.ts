...
export const DocumentClassificationResultSchema = z.object({
  ...
  classification: z.object({
    category: z.enum(['passport', 'visa', 'certificate', 'form', 'supporting_document', 'identification', 'financial', 'medical', 'educational', 'employment']),
...
export type MultiModalProcessingResult = z.infer<typeof MultiModalProcessingResultSchema>
