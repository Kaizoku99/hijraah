              ...
              <CardFooter className="flex justify-between pt-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onClick={(e: any) => handleEditDocument(document.id)}
                    >
                    ...
                    <DropdownMenuItem
                      onClick={(e: any) =>
                        handleUpdateVisibility(document.id, "private", e)
                      }
                    >
                    ...
                    <DropdownMenuItem
                      onClick={(e: any) =>
                        handleUpdateVisibility(document.id, "public", e)
                      }
                    >
                      <Share2 className="mr-2 h-4 w-4" />
                      Make Public
                    ...
                    <DropdownMenuItem
                      onClick={(e: any) =>
                        handleUpdateVisibility(document.id, "team", e)
                      }
                    >
                      <Share2 className="mr-2 h-4 w-4" />
                      Share with Team
