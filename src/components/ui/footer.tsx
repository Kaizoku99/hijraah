            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
                    ...
                    {footerLinks.map((section) => (
                        <div key={section.title} className="flex flex-col space-y-4" data-slot="footer-links-section">
                            <h3 className="font-semibold text-sm tracking-wider uppercase text-foreground">{section.title}</h3>
                            <ul className="flex flex-col space-y-2.5" data-slot="footer-links">
                ...
                >
                    <div className="flex items-center text-sm text-muted-foreground mb-3 md:mb-0" data-slot="footer-copyright">
                        <Copyright className="h-4 w-4 mr-2" />
                        <span>{currentYear} Hijraah. All rights reserved.</span>
                    </div>
                    <div className="flex items-center text-sm text-muted-foreground" data-slot="footer-tagline">
                        <span>Made with</span>
