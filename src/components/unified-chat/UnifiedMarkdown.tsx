...
export const UnifiedMarkdown = memo(function UnifiedMarkdown({
    ...
    console.log('Rendering markdown content:', content ? content.substring(0, 50) + '...' : 'undefined or empty')
        ...
        <ReactMarkdown
            ...
            components={{
                ...
                code({ node, className, children, ...props }) {
                    ...
                    if (!match) {
                        return (
                            <code className={cn('rounded-md bg-muted px-1 py-0.5 font-mono text-sm', className)} {...props}>
                                {code}
                            </code>
                        )
                    }
