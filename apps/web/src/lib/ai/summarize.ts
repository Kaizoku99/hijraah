    ...
    messages: [
      {
        role: "system",
        content:
          "You are a content classifier. Categorize this immigration-related content into one of the following categories: visa_policy, immigration_procedures, legal_requirements, country_specific_info, news, personal_experiences. Return only the category name, nothing else.",
      },
