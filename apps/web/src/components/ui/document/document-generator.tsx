...
const templateOptions = [
  {
    ...
    promptTips:
      "Include your background, skills, qualifications, and reason for immigration",
  },
  {
    ...
    promptTips:
      "Explain your background, education, work experience, and reasons for immigrating",
  },
  {
    id: "legal-brief",
    name: "Legal Brief",
    ...
    promptTips:
      "Include relevant case details, applicable laws, and your legal arguments",
  },
  {
    id: "affidavit",
    name: "Affidavit",
    ...
    promptTips:
      "Include facts, dates, places, and relevant information about your application",
  },
];
    ...
    try {
      ...
      if (result.saved) {
        ...
        toast({
          ...
          description:
            "Your document has been created and saved to your documents",
          variant: "default",
        });
        ...
        toast({
          ...
          description:
            "Document generated but could not be saved. Please try again.",
          variant: "destructive",
        });
      }
    } catch (error: any) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Provide detailed information for your document. The more
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Add any other details that might help generate a better
                    document
                  </p>
                  <FormMessage />
                </FormItem>
