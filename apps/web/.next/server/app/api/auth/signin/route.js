try {
  ...
  r &&
    ...
    (e._sentryDebugIds[r] = "ae2db83a-2fc5-445e-be8d-d65f3de0d87d"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-ae2db83a-2fc5-445e-be8d-d65f3de0d87d"));
} catch (e) {}
(() => {
  var e = {};
  (e.id = 4957),
    ...
    (e.modules = {
      ...
      26457: (e, r, t) => {
        ...
        function g() {
          return (h(), s)
            ? s
            : (s = (0, i.createBrowserClient)(c, d, {
                global: { headers: p },
              }));
        }
        function y() {
          return (
            h(), (0, i.createBrowserClient)(c, d, { global: { headers: p } })
          );
        }
        function b(e) {
          return (
            h(),
            (0, i.createServerClient)(c, d, {
              cookies: {
                get: (r) => e.get(r)?.value,
                set(r, t, s) {
                  try {
        ...
        let _ = (e) => {
            ...
            return (0, i.createServerClient)(c, d, {
              cookies: {
                get(e) {
      ...
      27316: (e, r, t) => {
        ...
        async function l(e) {
          let r = await e.formData(),
            t = String(r.get("email")),
            s = String(r.get("password")),
            i = String(r.get("redirectTo") || "/"),
            n = await (0, c.UU)(),
            { error: o } = await n.auth.signInWithPassword({
              email: t,
              password: s,
            });
          return o
            ? u.NextResponse.json({ error: o.message }, { status: 400 })
            : u.NextResponse.redirect(new URL(i, e.url));
        }
        let p = { ...a },
          f =
        ...
        let g = h(void 0, "GET"),
          ...
          m = new i.AppRouteRouteModule({
            ...
            resolvedPagePath:
              "E:\\downloads\\Hijraah\\apps\\web\\src\\app\\api\\auth\\signin\\route.ts",
            nextConfigOutput: "",
            userland: s,
          }),
      ...
      76387: (e, r, t) => {
        ...
        let n = { current: null },
          o = "function" == typeof s.cache ? s.cache : (e) => e,
          a = console.warn;
        function u(e) {
          return function (...r) {
            a(e(...r));
  ...
  r.C(e);
  var t = (e) => r((r.s = e)),
    s = r.X(0, [827, 7719, 8119, 5058, 5400, 131], () => t(27316));
  module.exports = s;
})();
