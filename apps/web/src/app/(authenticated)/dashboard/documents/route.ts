...
/**
 * Handle GET requests to /dashboard/documents by redirecting them to /api/documents
 */
export async function GET(request: NextRequest) {
  // Create a new request to the API route, preserving query parameters
  const apiUrl = new URL("/api/documents", request.url);
...
/**
 * Handle POST requests to /dashboard/documents by redirecting them to /api/documents
