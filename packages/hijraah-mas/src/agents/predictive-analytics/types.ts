...
export const UserProfileSchema = z.object({
  ...
  education: z.object({
    level: z
      .enum(["high_school", "bachelor", "master", "phd", "professional"])
      .optional(),
...
export type PredictiveAnalyticsConfig = z.infer<
  typeof PredictiveAnalyticsConfigSchema
>;
