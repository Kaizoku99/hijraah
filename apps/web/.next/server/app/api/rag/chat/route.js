try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = "a6e1c4cc-a9fd-4bbd-b2eb-4d08db8d95cc"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-a6e1c4cc-a9fd-4bbd-b2eb-4d08db8d95cc"));
} catch (e) {}
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [801],
  {
    ...
    26458: (e, t, i) => {
      "use strict";
      i.r(t), i.d(t, { ComponentMod: () => O, default: () => j });
      var r,
        a = {};
      i.r(a),
        i.d(a, {
      ...
      let g = "edge";
      async function h(e) {
        let t = new URL("/api/chat", e.url);
        return f.Rp.redirect(t, 307);
      }
      let y = { ...u },
        b =
          ...
          : new Proxy(e, {
              apply: (e, i, r) => {
                ...
                return m
                  .f(e, {
                    method: t,
                    parameterizedRoute: "/api/rag/chat",
                    headers: a,
                  })
                  .apply(i, r);
              },
      ...
      let x = v(void 0, "GET"),
        ...
        P = v(void 0, "HEAD"),
        T = v(void 0, "OPTIONS"),
        _ = new l.AppRouteRouteModule({
          definition: {
            kind: d.A.APP_ROUTE,
            page: "/api/rag/chat/route",
            pathname: "/api/rag/chat",
            filename: "route",
            bundlePath: "app/api/rag/chat/route",
          },
          resolvedPagePath:
            "E:\\downloads\\Hijraah\\apps\\web\\src\\app\\api\\rag\\chat\\route.ts",
          nextConfigOutput: "",
          userland: a,
        }),
        { workAsyncStorage: R, workUnitAsyncStorage: q, serverHooks: C } = _;
      function M() {
        return (0, p.V5)({ workAsyncStorage: R, workUnitAsyncStorage: q });
      }
      let A = {
          env: {
        ...
        D =
          null == (r = self.__RSC_MANIFEST) ? void 0 : r["/api/rag/chat/route"],
        I = ((e) => (e ? JSON.parse(e) : void 0))(self.__RSC_SERVER_MANIFEST);
      D &&
        I &&
        (0, n.fQ)({
          page: "/api/rag/chat/route",
          ...
          serverModuleMap: (0, s.e)({ serverActionsManifest: I }),
        });
      let O = o,
        j = c.s.wrap(_, { nextConfig: A });
    },
    43886: () => {},
    65521: (e) => {
      "use strict";
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [275, 83], () => t(26458));
    var i = e.O();
    (_ENTRIES = "undefined" == typeof _ENTRIES ? {} : _ENTRIES)[
      "middleware_app/api/rag/chat/route"
    ] = i;
  },
]);
