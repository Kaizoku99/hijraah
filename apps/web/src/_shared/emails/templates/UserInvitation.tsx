  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <strong>{organizationName}</strong> on Hijraah.
      </p>
      ...
      <p>
        Hijraah is an immigration platform that simplifies and streamlines the
        immigration process. Once you accept this invitation, you&apos;ll be
        able to access the organization&apos;s immigration services and tools.
      </p>

      <p className="text-secondary">
        This invitation was sent to {recipientEmail}. If you weren&apos;t
