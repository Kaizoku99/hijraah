...
export function ModelSelector({
    ...
    const defaultReasoningModel = cookies.get("preferred-reasoning-model") || "gpt-4-turbo";
    ...
    const [selectedReasoningModel, setSelectedReasoningModel] = React.useState<ModelOption>(
        reasoningModels.find((model) => model.id === defaultReasoningModel) || reasoningModels[0]
    );
