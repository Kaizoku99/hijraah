...
import { Locale, getTranslations, formatString } from '../i18n/translations';
...
export const PasswordResetI18n: React.FC<PasswordResetI18nProps> = ({
    ...
    const emailWithVariables = formatString(t.passwordReset.description, { email });
    ...
    return (
        ...
        >
            ...
            <p className="text-secondary">
                {t.passwordReset.expiryText}
            </p>

            <p className="mb-2">
                {t.common.cta.regards}<br />
                {t.common.cta.team}
            </p>
        </BaseEmailI18n>
    );
