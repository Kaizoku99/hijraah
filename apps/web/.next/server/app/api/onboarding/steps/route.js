try {
  ...
  r &&
    ...
    (e._sentryDebugIds[r] = "87fe6f29-f2e1-4368-a1a6-f416b59598d4"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-87fe6f29-f2e1-4368-a1a6-f416b59598d4"));
} catch (e) {}
(() => {
  var e = {};
  (e.id = 2541),
    ...
    (e.modules = {
      ...
      4813: (e, r, t) => {
        ...
        async function p(e) {
          ...
          return u
            ? "PGRST116" === u.code
              ? c.NextResponse.json({
                  initialized: !1,
                  shouldStartOnboarding: !0,
                })
              : c.NextResponse.json({ error: u.message }, { status: 500 })
            : c.NextResponse.json({
                initialized: !0,
                currentStep: n.current_step,
                progress: n.progress,
                isCompleted: n.is_completed,
                shouldStartOnboarding: !n.is_completed,
              });
        }
        let l = { ...u },
          f =
                ...
                apply: (e, t, s) => {
                  ...
                  return d
                    .wrapRouteHandlerWithSentry(e, {
                      method: r,
                      parameterizedRoute: "/api/onboarding/steps",
                      headers: i,
                    })
                    .apply(t, s);
                },
        ...
        let x = h(p, "GET"),
          ...
          m = h(void 0, "HEAD"),
          _ = h(void 0, "OPTIONS"),
          E = new i.AppRouteRouteModule({
            definition: {
              kind: o.RouteKind.APP_ROUTE,
              page: "/api/onboarding/steps/route",
              pathname: "/api/onboarding/steps",
              filename: "route",
              bundlePath: "app/api/onboarding/steps/route",
            },
            resolvedPagePath:
              "E:\\downloads\\Hijraah\\apps\\web\\src\\app\\api\\onboarding\\steps\\route.ts",
            nextConfigOutput: "",
            userland: s,
          }),
          { workAsyncStorage: O, workUnitAsyncStorage: w, serverHooks: v } = E;
        function R() {
