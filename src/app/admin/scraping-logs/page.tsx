            ...
            <div className="mb-6">
                <div className="flex space-x-4 border-b">
                    <button
                        ...
                        className={`py-2 px-4 border-b-2 ${activeTab === 'logs'
                    ...
                    <button
                        ...
                        className={`py-2 px-4 border-b-2 ${activeTab === 'history'
                                ? 'border-primary text-primary font-medium'
                                : 'border-transparent text-muted-foreground'
                            }`}
                    >
                                    ...
                                    <TableBody>
                                        {scrapeHistory.map((item) => (
                                            <TableRow key={item.id}>
                                                ...
                                                <TableCell>
                                                    {item.status === 'success' && (
                                                        <Badge variant={item.has_changes ? "outline" : "secondary"}>
                                                            {item.has_changes ? "Changes Detected" : "No Changes"}
                                                        </Badge>
                                                    )}
                                                </TableCell>
                                                <TableCell className="max-w-md truncate">
                                                    {item.error_message || (item.has_changes ? item.change_summary : "Successful scrape")}
                                                </TableCell>
                                                <TableCell>
                                                    {item.artifact_id && (
