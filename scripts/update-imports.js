...
const importMappings = [
  ...
  { from: '@/core/document-service', to: '@/core/documents/services/document-service' },
  { from: '@/core/chat-service', to: '@/core/chat/services/chat-service' },
  { from: '@/core/research/types', to: '@/core/research/lib/types' },
  { from: '@/core/documents/processor', to: '@/core/documents/services/processor' },
  ...
  { from: '../../domain/entities/roadmap', to: '@/core/immigration/entities/roadmap' },

  // Shared UI fixes
  { from: '@/shared/ui/create-artifact', to: '@/artifacts/components/create-artifact' },
  ...
  // Context fixes
  { from: '@/shared/contexts/artifact-context', to: '@/lib/contexts/artifact-context' },
  ...
  { from: '@/components/chat/ChatMessage', to: '@/components/ui/unified-chat/ChatMessage' },
  { from: '@/components/documents/DocumentAnalyzer', to: '@/components/ui/documents/analyze/DocumentAnalyzer' },
  { from: '@/components/documents/AnalysisHistory', to: '@/components/ui/documents/analyze/AnalysisHistory' },
  ...
  { from: '../lib/i18n/translation-validator', to: '@/lib/i18n/translation-validator' },
  { from: '../i18n', to: '@/i18n' },
  { from: './i18n', to: '@/lib/i18n' },
  { from: '@/lib/document/document-comparison', to: '@/lib/document/comparison' },
...
const main = () => {
  ...
  if (updatedCount > 0) {
    ...
    console.log('You may need to manually adjust some imports that were not automatically updated.');
  }
};
