                ...
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
                          placeholder={t("form.fields.selectType")}
                        />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      <SelectItem value="visa">
                        {t("form.fields.types.visa")}
                      </SelectItem>
                      <SelectItem value="residence">
                        {t("form.fields.types.residence")}
                      </SelectItem>
                      <SelectItem value="citizenship">
                        {t("form.fields.types.citizenship")}
                      </SelectItem>
                      <SelectItem value="asylum">
                        {t("form.fields.types.asylum")}
                      </SelectItem>
                      <SelectItem value="other">
                        {t("form.fields.types.other")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                ...
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
                          placeholder={t("form.fields.selectPriority")}
                        />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      <SelectItem value="low">
                        {t("form.fields.priorities.low")}
                      </SelectItem>
                      <SelectItem value="medium">
                        {t("form.fields.priorities.medium")}
                      </SelectItem>
                      <SelectItem value="high">
                        {t("form.fields.priorities.high")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
