...
import { Loader2, GalleryVerticalEnd, ArrowRight, Mail, KeyRound } from 'lucide-react';
import {
  Card,
  CardContent,
  CardDescription,
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-background to-muted flex min-h-svh flex-col items-center justify-center p-4 md:p-8">
        ...
        >
          <Link href="/" className="flex items-center gap-3 self-center transition-transform hover:scale-105">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-3">
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="flex-shrink-0 size-4 mr-2">
                          <path
