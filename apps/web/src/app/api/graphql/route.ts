...
const { handleRequest } = createYoga<GraphQLContext>({
  ...
  context: async ({ request }) => {
    ...
    let supabaseClient: ReturnType<typeof createSupabaseClient<Database>> | undefined = undefined;
    ...
    try {
      ...
      if (jwt) {
        ...
        if (userError) {
          ...
          console.log('No JWT found in Authorization header for GraphQL request.');
      }
