...
export const OnboardingProgress: React.FC = () => {
    const { onboarding, hideOnboardingForSession, resetOnboarding, nextStep } = useOnboarding();
    ...
    return (
        <div className={`${positionClasses} bg-card shadow-lg rounded-lg p-4 w-full max-w-md border flex flex-col gap-3`}>
