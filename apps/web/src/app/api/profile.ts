...
import {
  ...
  UserProfileInsert,
  UserProfileUpdate,
} from "@/_infrastructure/repositories/user-profile-repository";
...
export async function getUserProfile(
  ...
  console.warn(
    "getUserProfile is deprecated. Use UserProfileRepository.getByUserId instead.",
  );
...
export async function createOrUpdateProfile(
  ...
  console.warn(
    "createOrUpdateProfile is deprecated. Use UserProfileRepository.upsert instead.",
  );
...
export async function updateUserTheme(
  ...
  console.warn(
    "updateUserTheme is deprecated. Use UserProfileRepository.updateTheme instead.",
  );
...
export async function updateUserLanguage(
  ...
  console.warn(
    "updateUserLanguage is deprecated. Use UserProfileRepository.updateLanguage instead.",
  );
...
export async function updateNotificationSettings(
  ...
  console.warn(
    "updateNotificationSettings is deprecated. Use UserProfileRepository.updateNotificationSettings instead.",
  );
...
export async function updateUserAvatar(
  ...
  console.warn(
    "updateUserAvatar is deprecated. Use UserProfileRepository.updateAvatar instead.",
  );
