...
export async function updateArtifact(
  ...
  if (fetchError) {
    ...
    throw new Error(
      `Failed to fetch artifact for update: ${fetchError.message}`,
    );
  }
...
export async function deleteArtifact(
  ...
  if (fetchError) {
    ...
    throw new Error(
      `Failed to fetch artifact for deletion: ${fetchError.message}`,
    );
  }
  ...
  if (messagesError) {
    ...
    throw new Error(
      `Failed to delete artifact messages: ${messagesError.message}`,
    );
  }
...
export async function addArtifactMessage(
  ...
  if (fetchError) {
    ...
    throw new Error(
      `Failed to fetch artifact for message: ${fetchError.message}`,
    );
  }
...
export async function getArtifactMessages(
  artifactId: string,
  userId: string,
): Promise<ArtifactMessage[]> {
  const supabase = await getSupabaseServerClient();
  ...
  if (fetchError) {
    ...
    throw new Error(
      `Failed to fetch artifact for messages: ${fetchError.message}`,
    );
  }
  ...
  if (!canAccessArtifact) {
    throw new Error(
      "You do not have permission to view messages for this artifact",
    );
  }
