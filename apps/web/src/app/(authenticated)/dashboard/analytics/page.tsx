...
import { Loader2, FileText, Users, Briefcase, Calendar, AlertTriangle, TrendingUp } from 'lucide-react';
...
export default function AnalyticsPage() {
    ...
    const getCasesByType = () => {
        ...
        return Object.entries(caseTypeCounts).map(([name, value]) => ({ name, value }));
    };
    ...
    const getCasesByStatus = () => {
        ...
        return Object.entries(caseStatusCounts).map(([name, value]) => ({ name, value }));
    };
    ...
    const getDocumentsByStatus = () => {
        ...
        return Object.entries(documentStatusCounts).map(([name, value]) => ({ name, value }));
    };
                    ...
                    <div className="container mx-auto p-6">
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {cases.length > 0 ? `+${Math.floor(cases.length * 0.1)} from last month` : 'No cases yet'}
                                    </p>
                                </CardContent>
                            </Card>
                            <Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {documents.length > 0 ? `${Math.floor(documents.length / (cases.length || 1))} per case avg.` : 'No documents'}
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <Tabs defaultValue="overview" className="mb-6">
                            ...
                            <TabsContent value="overview" className="p-4 border rounded-md">
                                <h2 className="text-lg font-medium mb-4">Case Creation Over Time</h2>
                            ...
                            <TabsContent value="cases" className="p-4 border rounded-md">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-medium mb-4">Cases by Status</h2>
                                        <div className="flex justify-center">
                                            <PieChart width={300} height={300}>
                                                <Pie
                            ...
                            <TabsContent value="documents" className="p-4 border rounded-md">
                                <h2 className="text-lg font-medium mb-4">Documents by Status</h2>
                                <div className="flex justify-center">
