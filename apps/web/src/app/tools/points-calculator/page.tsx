      ...
      <Card className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) => setPoints({ ...points, education: value })}
              defaultValue="0"
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) => setPoints({ ...points, experience: value })}
              defaultValue="0"
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) => setPoints({ ...points, language: value })}
              defaultValue="0"
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(value) => setPoints({ ...points, adaptability: value })}
              defaultValue="0"
            >
              <SelectTrigger>
            ...
            <div className="text-sm text-muted-foreground">
              {calculateTotal() >= 67 ? (
                ...
                <p className="text-yellow-600 dark:text-yellow-400">
                  You need {67 - calculateTotal()} more points to meet the minimum requirement of 67 points.
                </p>
              )}
            </div>
          </div>
