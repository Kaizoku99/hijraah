...
export const recommendationTool = createImmigrationTool(
  ...
  z.object({
    caseId: z.string(),
    caseData: z.record(z.any()),
    analysisResults: z.record(z.any()),
    recommendationType: z.enum(['processing', 'decision', 'improvement', 'compliance']).default('processing')
  }),
      ...
      recommendations: [
        {
          ...
          description: 'Passport authenticity requires additional verification due to security feature concerns',
        ...
        },
        {
          ...
          description: 'Current financial proof does not meet updated requirements',
      ...
      mockRecommendations.recommendations = [
        {
          ...
          description: 'All requirements met, recommend approval with standard conditions',
