try {
  ...
  r &&
    ...
    (e._sentryDebugIds[r] = "7404bda6-b351-424f-806b-faf0cea1aa9d"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-7404bda6-b351-424f-806b-faf0cea1aa9d"));
} catch (e) {}
(() => {
  var e = {};
  (e.id = 8887),
      ...
      2768: (e, r, t) => {
        ...
        async function l(e) {
          let r = await e.formData(),
            ...
            o = String(r.get("fullName") || ""),
            i = await (0, c.UU)(),
            n = new URL(e.url).origin,
            { error: a } = await i.auth.signUp({
              email: t,
              password: s,
              options: {
                emailRedirectTo: `${n}/auth/callback`,
                data: { full_name: o, role: "user" },
              },
            });
          return a
            ? u.NextResponse.json({ error: a.message }, { status: 400 })
            : u.NextResponse.redirect(new URL("/auth/check-email", e.url));
        }
        let p = { ...a },
          f =
        ...
        let g = h(void 0, "GET"),
          ...
          E = new o.AppRouteRouteModule({
            ...
            resolvedPagePath:
              "E:\\downloads\\Hijraah\\apps\\web\\src\\app\\api\\auth\\signup\\route.ts",
            nextConfigOutput: "",
            userland: s,
          }),
          { workAsyncStorage: w, workUnitAsyncStorage: O, serverHooks: q } = E;
        function S() {
  ...
  r.C(e);
  var t = (e) => r((r.s = e)),
    s = r.X(0, [827, 7719, 8119, 5058, 5400, 131], () => t(2768));
  module.exports = s;
})();
