try {
  ...
  t &&
    ...
    (e._sentryDebugIds[t] = "2f3a0233-f39a-4ebe-966a-ec53df6682dc"),
    (e._sentryDebugIdIdentifier =
      "sentry-dbid-2f3a0233-f39a-4ebe-966a-ec53df6682dc"));
} catch (e) {}
("use strict");
(exports.id = 131),
  (exports.ids = [131]),
  (exports.modules = {
    ...
    80985: (e, t, r) => {
      ...
      function g() {
        ...
        if (((this[b].disturbed = !0), this[b].error))
          return m.Promise.reject(this[b].error);
        let t = this.body;
        ...
        return (
          ...
          new J.Promise(function (r, o) {
            ...
            let c,
              ...
              b = ("https:" === h.protocol ? u : i).request,
              y = d.signal,
              m = null,
              g = function () {
            ...
            function S() {
              T.abort(),
                y && y.removeEventListener("abort", w),
                clearTimeout(c);
            }
            y && y.addEventListener("abort", w),
              d.timeout &&
              ...
              (s = T),
              (l = function (e) {
                (!y || !y.aborted) && m && m.body && W(m.body, e);
              }),
