 ...
 */
function getDefaultTemplate(documentType: DocumentType, targetCountry?: string): DocumentTemplate {
  ...
  switch (documentType) {
    ...
    case DocumentType.BIRTH_CERTIFICATE:
      return {
        ...
        sections: ['Child Information', 'Parent Information', 'Registration Details'],
        validations: {
          registrationNumber: {
            minLength: 5,
            maxLength: 30,
      ...
      return {
        ...
        fields: {
          credentialType: {
            type: 'string',
            required: true,
            description: 'Type of credential (e.g., Degree, Diploma, Certificate)',
          },
          institutionName: {
            type: 'string',
            required: true,
          ...
          degreeLevel: {
            type: 'string',
            required: false,
            description: 'Level of degree (e.g., Bachelor\'s, Master\'s, Doctorate)',
          },
          majorField: {
            type: 'string',
            required: false,
        ...
        sections: ['Student Information', 'Institution Information', 'Program Details', 'Verification'],
        validations: {},
      };
