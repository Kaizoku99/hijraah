            ...
            name(module) {
              ...
              if (module.context.includes("node_modules")) {
                ...
                if (matchResult && matchResult[1]) {
                  ...
                  const sanitizedName = packageName.replace(
                    /[^a-zA-Z0-9_.-]/g,
                    "",
                  );
              ...
              const lastMeaningfulPart =
                pathParts.filter(Boolean).slice(-2)[0] || "app";
...
export default withSentryConfig(
  withBundleAnalyzerConfig(withNextIntl(nextConfig)),
  {
