...
export const EmailConfirmation: React.FC<EmailConfirmationProps> = ({
    ...
    return (
        <BaseEmail previewText="Confirm your Hijraah email address" title="Confirm Your Email">
            ...
            <p className="text-secondary">
                This confirmation link will expire in 24 hours. If you don&apos;t confirm within that time,
                you&apos;ll need to sign up again.
            </p>

            <p className="mb-2">
                Welcome to Hijraah!<br />
                The Hijraah Team
            </p>
        </BaseEmail>
    );
